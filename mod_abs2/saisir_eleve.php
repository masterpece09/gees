...
if (getSettingValue("GeesAccesAbsTouteClasseCpe")=='yes' && $utilisateur->getStatut() == "cpe") {
...
if ($type_selection == 'id_eleve') {
    ...
    if ($utilisateur->getStatut() != "cpe" || getSettingValue("GeesAccesAbsTouteClasseCpe")!='yes') {
