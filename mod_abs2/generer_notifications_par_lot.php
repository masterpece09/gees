...
<fieldset>
	...
	<form id="fichierPerso" method="post" action="generer_notifications_par_lot.php" enctype="multipart/form-data" >
		<label for="gabarit" title="Pour revenir au modèle de GEES, laissez le champ vide et validez">
			Utiliser le gabarit : <?php echo (isset ($_SESSION['monFichier']) ? $_SESSION['monFichier'] : 'de GEES'); ?>
		</label>
		<br />
		<input type="file" 
			   name="monFichier" 
