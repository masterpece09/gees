...
...</pre>\n";
    ...
    $csv_file = isset($_FILES["csv_file"]) ? $_FILES["csv_file"] : NULL;
        ...
        if(!$fp) {
            ...
            echo "<p>Dans le tableau ci-dessous, les identifiants en rouge correspondent à des nouvelles matières dans la base GEES. les identifiants en vert correspondent à des identifiants de matières détectés dans le fichier CSV mais déjà présents dans la base GEES.</p>\n";
            ...
            if ($nb_reg_no != 0) {
                ...
                echo "<p>L'importation des matières dans la base GEES a été effectuée avec succès !<br />";
            }
        }
}
