...
<div style='float:right; width:16px' class='noprint'>
	<a href='mailto:".$current_ele['email']."?".urlencode("subject=".getSettingValue('gepiPrefixeSujetMail')."[GEES]")."' title='Envoyer un mail à cet élève'><img src='../images/icons/mail.png' class='icone16' alt='Mail' /></a>
</div>";
...
if(getSettingValue('envoi_mail_liste')=='y') {
	...
	if(count($tabmail)>0){
		...
		//echo "<p>Envoyer un <a href='mailto:$chaine_mail?".rawurlencode("subject=[GEES]")."'>mail à tous les élèves de l'enseignement</a>.</p>\n";
		echo "<p>Envoyer un <a href='mailto:$chaine_mail?".rawurlencode("subject=".getSettingValue('gepiPrefixeSujetMail')."[GEES]")."'>mail à tous les élèves</a>.</p>\n";
	}
}
?>
