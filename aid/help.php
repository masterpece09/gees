...
<p>Ces fiches sont accessibles dans GEES à différents
types d'utilisateurs connectés (administrateur, professeur, cpe, élève ou responsable)</p>

<p>Ces fiches sont également en partie accessibles dans l'interface publique de GEES à différents. Un paramètrage permet de déterminer les champs visibles ou non par le public.</p>
