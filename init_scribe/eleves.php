...
if (isset($_POST['step'])) {
    ...
    if ($_POST['step'] == "1") {
        ...
        if ($_POST['record'] == "yes") {
            ...
            echo "<p>Les classes en vert indiquent des classes déjà existantes dans la base GEES.<br />Les classes en rouge indiquent des classes nouvelles et qui vont être ajoutées à la base GEES.<br /></p>";
    ...
    //----***** STEP 2 *****-----//
        ...
        for($i=0;$i<$info["count"];$i++) {
            ...
            // -----
            // DEPRECIATION : les lignes ci-dessous ne sont plus nécessaire, Gees a été mis à jour
            //
            // Pour des raisons de compatibilité avec le code existant de Gees, il n'est pas possible d'avoir
    ...
    if ($flag != 0){
        ...
        echo "Des données concernant la constitution des classes et l'affectation des élèves dans les classes sont présentes dans la base GEES ! Si vous poursuivez la procédure, ces données seront définitivement effacées !</p>";
    }

    echo "<p>Etes-vous sûr de vouloir importer tous les élèves depuis l'annuaire du serveur Scribe vers Gees ?</p>";
    echo "<br/>";
