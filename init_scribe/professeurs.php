...
if (isset($_POST['is_posted'])) {
	...
	echo "<ul>";
	echo "<li>Passage à l'état 'inactif' de tous les professeurs déjà présents dans la base Gees</li>";
    ...
    echo "<p>Etes-vous sûr de vouloir importer tous les utilisateurs depuis l'annuaire du serveur Scribe vers Gees ?</p>";
    echo "<br/>";
