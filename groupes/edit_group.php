...
elseif(getSettingValue('bul_rel_nom_matieres')=='nom_groupe') {
	...
	$message_nom_sur_bulletin1="&nbsp;<img src='../images/info.png' width='20' height='20' title=\"C'est le nom court de l'enseignement ('groupe' dans le vocabulaire Gees) qui apparait sur les bulletins.
C'est le paramétrage que vous avez effectué dans Gestion générale/Configuration générale.
Ce paramétrage est global, commun à toutes les classes.\" />";
}
elseif(getSettingValue('bul_rel_nom_matieres')=='description_groupe') {
	...
	$message_nom_sur_bulletin2="&nbsp;<img src='../images/info.png' width='20' height='20' title=\"C'est la description de l'enseignement ('groupe' dans le vocabulaire Gees) qui apparait sur les bulletins.
C'est le paramétrage que vous avez effectué dans Gestion générale/Configuration générale.
Ce paramétrage est global, commun à toutes les classes.\" />";
}
...
if(mysqli_num_rows($test)>0) {
	...
	if(mysqli_num_rows($res_edt)>0) {
		...
		echo "<p style='margin-top:1em;'><span id='span_regroupement_edt_associe'>Aucun regroupement EDT n'est associé à ce groupe Gees</span> <a href='maj_inscript_ele_d_apres_edt.php?action=editer_ec3&amp;id_groupe=".$id_groupe."' onclick=\"afficher_div('div_regroupement_edt','y',10,10);return false;\" title=\"Associer.\"><img src='../images/edit16.png' class='icone16' alt='Associer' /></a>.";
	}
	...
	if(count($tab_assoc)>1) {
		$texte_infobulle.="<p style='color:red; text-indent:-6em; margin-left:6em;'>ANOMALIE&nbsp;: Le groupe/enseignement Gees est associé à ".count($tab_assoc)." regroupements EDT (<em>";
		$chaine_anomalie_corresp_edt="<img src='../images/icons/flag2.gif' alt='Anomalie' class='icone16' title=\"ANOMALIE : Le groupe/enseignement Gees est associé\n                     à ".count($tab_assoc)." regroupements EDT:\n";
...
<div>
	...
	<div style='margin-left:4em;'>
		<ul>
			...
			<li>le nom court de l'enseignement (<em>\"groupe\" dans le vocabulaire Gees</em>)$choix_nom_sur_bulletin1</li>
			<li>la description de l'enseignement (<em>\"groupe\" dans le vocabulaire Gees</em>)$choix_nom_sur_bulletin2</li>
		</ul>
