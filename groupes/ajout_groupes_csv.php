...
<ul>
	<li>
		...
		NOM_GROUPE;DESCRIPTION_GROUPE;ID_MATIERE_GEES;NOM_DES_CLASSES;LOGIN_PROFS<br />
		...
		if($step==0) {
			...
			if(!is_uploaded_file($csv_file['tmp_name'])) {
				...
				if(!$res_copy) {
					...
					$tabchamps = array("NOM_GROUPE", "DESCRIPTION_GROUPE", "ID_MATIERE_GEES", "NOM_DES_CLASSES", "LOGIN_PROFS");
