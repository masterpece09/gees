...
if(!isset($step)) {
	echo "<p>Sconet peut recevoir un fichier XML des affectations élèves dans les groupes de Gees.<br />
...
<IMPORT_ELEVES VERSION=\"1.3\">
	<PARAMETRES>
		<UAJ>".getSettingValue('GeesSchoolRne')."</UAJ>
