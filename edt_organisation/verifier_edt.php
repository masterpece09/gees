...
if (!strstr($ua, "MSIE 6.0")) {
    ...
    if (mysqli_num_rows($req_profs) != 0) {
        ...
        echo "<p style=\"text-align:center;\">".mysqli_num_rows($req_profs)." enseignant(s) inscrit(s) dans les emplois du temps n'existe(nt) plus dans GEES</p>";
        ...
        echo '<p style="text-align:center;font-size:1.2em;border-bottom:1px solid black;"><strong>Test 1</strong></p>';
        echo '<p style="text-align:center;">Il y a concordance parfaite entre enseignants enregistrés sur GEES et ceux enregistrés dans les emplois du temps</p>';
...
if (!strstr($ua, "MSIE 6.0")) {
    ...
    if (mysqli_num_rows($req_groupes) != 0) {
	    ...
	    echo "<p style=\"text-align:center;\">".mysqli_num_rows($req_groupes)." enseignement(s) inscrit(s) dans les emplois du temps n'existe(nt) plus dans GEES</p>";
	    ...
	    echo '<p style="text-align:center;font-size:1.2em;border-bottom:1px solid black;"><strong>Test 2</strong></p>';
        echo '<p style="text-align:center;">Il y a concordance parfaite entre enseignements enregistrés sur GEES et ceux enregistrés dans les emplois du temps</p>';
...
if (!strstr($ua, "MSIE 6.0")) {
    ...
    if (mysqli_num_rows($req_groupes) != 0) {
	    ...
	    echo "<p style=\"text-align:center;\">".mysqli_num_rows($req_groupes)." aid(s) inscrit(s) dans les emplois du temps n'existe(nt) plus dans GEES</p>";
        echo '<p style="text-align:center;padding:8px;">
	           <a style="background-color:#FFFABD;border:2px solid black;padding:2px;" href="./verifier_edt.php?supprimer=suppression_groupes'.add_token_in_url().'">Lancer la procédure de nettoyage</a>
            </p>';
    }
        ...
        echo '<p style="text-align:center;font-size:1.2em;border-bottom:1px solid black;"><strong>Test 3</strong></p>';
        echo '<p style="text-align:center;">Il y a concordance parfaite entre aids enregistrés sur GEES et ceux enregistrés dans les emplois du temps</p>';
