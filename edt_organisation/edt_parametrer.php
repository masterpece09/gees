...
// Fichier utilisé par l'administrateur pour paramétrer l'EdT de Gees
...
if (isset($parametrer_ok)) {
	...
	$message = "Dans cette page, vous pouvez paramétrer l'affichage des emplois du temps pour tous les utilisateurs de Gees.";
}
