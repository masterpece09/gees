...
<p>Le module d'emplois du temps de GEES a trois vocations : </p>
...
<p>Ce scenario est différent des deux précédents au moment du remplissage des emplois du temps. Au lieu de faire une saisie manuelle, on importe un fichier contenant tous les emplois du temps. Ce fichier doit être formaté de façon à être reconnu par GEES. Actuellement, le module d'emploi du temps vous propose trois formats d'importation possible : un simple fichier .csv, un fichier d'export du logiciel UnDeuxTemps, un export de type Charlemagne. La difficulté de cette importation est de taille : il faut faire coincider les enseignements contenus dans GEES avec ceux contenus dans le fichier importé. D'ailleurs, il n'est pas rare de devoir finir ce travail d'importation manuellement pour quelques enseignements. Pour que cette importation se passe au mieux, le travail préliminaire suivant est indispensable.</p>
