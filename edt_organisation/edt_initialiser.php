...
<hr />
	<p>
	Pour entrer des informations dans l'emploi du temps de Gees, il y a plusieurs possibilit&eacute;s.
	<br /><br />
...
if ($aff_reglages2 == "oui") {
	...
	<h5>Pour l\'initialisation du d&eacute;but d\'ann&eacute;e, les diff&eacute;rents logiciels de conception des emplois
 	...
 	<h4 class="red">Pour les procédures suivantes, vous pouvez demander à Gees d\'effacer les cours existants ou décider de les conserver.</h4>
...
depuis Gees 1.6.6">Ancien dispositif pour EDT&nbsp;: </span><a href="./edt_xml.php">Générer un export de type UnDeuxTemps à partir d\'un export EXP_COURS.xml d\'IndexEducation.</a></p>
		<br />
	</div>
';
	}
