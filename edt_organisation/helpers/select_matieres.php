...
echo '
	<select name ="' . $increment . '"'.$warning .' onmouseover="if(document.getElementById(\'texte_nomGees'.$l.'\')) {document.getElementById(\'texte_nomGees'.$l.'\').style.backgroundColor=\'yellow\'}" onmouseout="if(document.getElementById(\'texte_nomGees'.$l.'\')) {document.getElementById(\'texte_nomGees'.$l.'\').style.backgroundColor=\'\'}">
