...
<ul>
	...
	<li><p>S'assurer que les identifiants (les codes) des matières soient les mêmes dans EDT et dans Gees (<strong>Onglet Matières</strong>) pour faciliter l'établissement des correspondances lors de l'importation dans Gees. Faire attention en particulier aux identifiants des langues<br />(<em>ex : ALL1 utilisé dans EDT ne sera pas associé aussi facilement  par Gees si on y utilise ALLBI au lieu d'ALL1</em>).</p></li>
...
<ol>
<li>Se placer dans l'onglet Cours et extraire les cours que l'on veut voir figurer dans l'edt de Gees. Si l'on veut exporter l'ensemble de l'emploi du temps, faire une extraction complète (<strong>Extraire > Tout extraire</strong>).</li>
...
<li>EDT génère le fichier <strong>EXP_COURS.xml</strong> dont Gees aura besoin</li>
</ol>\n";
			echo "<p><br /></p>\n";
		}
		else {
...
*/
				...
				*/
				...
				fclose($fich);
				echo "<p>Fichier CSV produit au format d'un export UDT&nbsp;: <a href='../temp/".$tempdir."/g_edt_2.csv'>g_edt_2.csv</a><br />Vous pouvez fournir ce fichier dans Gees en choisissant un import de type UDT.</p>\n";
			}
		}
	}
	require("../lib/footer.inc.php");
