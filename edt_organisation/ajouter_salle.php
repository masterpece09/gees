...
/**
 * Fichier permettant d'ajouter des salles dans l'EdT de Gees
 *
 *
...
<?php echo MANAGE_GEES_CLASSROOMS ?>
<br /><br />
...
if ($_SESSION["statut"] == "administrateur" AND isset($del_salle) AND $del_salle != NULL AND $del_salle != "rien") {
	...
	echo '
	<font color="green">La salle '.$rep_nom["numero_salle"].$aff_nom_salle.' a été effacée de la base de Gees.</font>';
}
?>
			</td><td>
