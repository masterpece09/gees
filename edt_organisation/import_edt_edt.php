...
function enregistre_corresp_EDT_classe_matiere_GEES_id_groupe($id_groupe, $nom_groupe_edt, $mat_code_edt) {
...
elseif($action=="rapprochements") {
	...
	<fieldset class='fieldset_opacite50'>
		".add_token_field()."
		<p>La ou les correspondances de matières EDT/GEES suivantes ne sont pas encore enregistrées.</p>
...
Heure début : ".$ligne[$loop]['h_debut']."\">".$current_mat_code_edt."&nbsp;: </td>
	...
	echo "<br />
		<p>La ou les correspondances d'identités de professeurs EDT/GEES suivantes ne sont pas encore enregistrées.</p>
		<table class='boireaus boireaus_alt'>";
...
*/
	echo "<br />
		<p>La ou les correspondances de <strong>classes</strong> EDT/GEES suivantes ne sont pas encore enregistrées.<br />
	...
	echo "<br />
		<p>La ou les correspondances de <strong>groupes</strong> EDT/GEES suivantes ne sont pas encore enregistrées.<br />
...
<script type='text/javascript'>
	...
	*/
	...
	echo "<br />
		<p>La ou les correspondances de <strong>salles</strong> EDT/GEES suivantes ne sont pas encore enregistrées.</p>
		<table class='boireaus boireaus_alt'>";
	...
	echo "<br />
		<p>La ou les correspondances de <strong>jours</strong> EDT/GEES suivantes ne sont pas encore enregistrées.</p>
		<table class='boireaus boireaus_alt'>";
	...
	echo "<br />
		<p>La ou les correspondances d'<strong>horaires de début de cours</strong> EDT/GEES suivantes ne sont pas encore enregistrées.</p>
		<table class='boireaus boireaus_alt'>";
	...
	echo "<br />
		<p>La ou les correspondances de <strong>types de semaines</strong> EDT/GEES suivantes ne sont pas encore enregistrées.</p>
		<table class='boireaus boireaus_alt'>";
...
*/
				...
				if(!$insert) {
					...
					enregistre_corresp_EDT_classe_matiere_GEES_id_groupe($edt_cours_id_groupe, $tab['classe'], $tab['mat_code']);
	...
	<tr>
		...
		<th title=\"Dans le cas où le nom de regroupement EDT a précédemment été associé à un des enseignements Gees lors d'un précédent import, les informations correspondantes seront affichées ici.\">Choix précédent</th>
	</tr>
	<tr>
		<td>";
			if($tab['classe']=='') {
			...
			*/
			...
			if(!isset($tab_grp_associes_precedent_import['"'.$current_nom_regroupement_edt.'"'])) {
				...
				if(mysqli_num_rows($res_choix_prec)>0) {
					...
					$tab_grp_associes_precedent_import['"'.$current_nom_regroupement_edt.'"']['lignes'].="Lors d'un précédent import de l'emploi du temps, le regroupement EDT ".$tab['classe']." a été associés aux groupes Gees suivants&nbsp;:<br />";
...
*/
	...
	//<div id='div_detail_groupe_titre2'>Groupe Gees</div>
	$tabdiv_infobulle[]=creer_div_infobulle("div_detail_groupe","Groupe Gees","",$texte_infobulle,"",20,0,'y','y','n','n');
		...
		<fieldset class='fieldset_opacite50'>
			...
			<table class='boireaus boireaus_alt resizable sortable'>
				<tr>
					...
					<th class='text' title='Trier suivant cette colonne'>GEES</th>
