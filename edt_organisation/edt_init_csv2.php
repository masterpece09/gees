    ...
    if (file_exists("../temp/".$tempdir."/g_edt_2.csv") === TRUE) {
        ...
        if (!$fp) {
            ...
            $titre = array('Les jours de la semaine',
                ...
                'Les professeurs : ',
                'Les salles : <b>Gees vérifie l\'existence de ces salles et crée celles qui n\'existent pas.</b>',
                'Les groupes : subdivisions des regroupements',
                'Les regroupements : ce sont les enseignements ou les AID de Gees',
            ...
            if ($etape != 12) {
				...
				foreach ($tableau as $key => $val) {
					...
					<label for="nomGees' . $l . '" id="texte_nomGees' . $l . '" ><b>' . $val . '</b></label>
					';
					...
					//}
                    $nom_id_select = 'nomGees' . $l; // pour le id du select (en mettre en liaison avec le for du label ci-dessus)
...
?>
<h3 class="red">Initialiser l'emploi du temps de Gees &agrave; partir d'un export csv d'un logiciel propri&eacute;taire.</h3>
...
<p>Pour chaque partie, vous allez devoir faire le lien avec les informations de Gees. Vous devrez donc faire passer le fichier csv 12 fois et
la derni&egrave;re sera la plus longue. Par contre, les 11 premi&egrave;res &eacute;tapes seront conserv&eacute;es par Gees et vous pourrez faire la derni&egrave;re
 &eacute;tape (importation des cours eux-m&ecirc;mes) autant de fois que vous le d&eacute;sirez (en effa&ccedil;ant les anciens cours ou non).</p>
	...
	<p><span class="red">Attention</span> de respecter au mieux les heures, jour, nom de mati&egrave;re,... de Gees que vous avez pr&eacute;cis&eacute;s auparavant,
...
<br /><br />
	...
	<!--div class="mode_gr">
	<p>Voulez-vous que Gees cr&eacute;e tous les cours qu'il ne reconnait pas ?</p>
