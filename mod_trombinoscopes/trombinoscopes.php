...
<?php
	...
	if ( ( $classe === 'toutes' or $groupe === 'toutes' or $equipepeda === 'toutes' or $discipline === 'toutes' ) or ( $classe === '' and $groupe === '' and $aid === '' and $equipepeda === '' and $discipline === '' and $statusgepi === '' ) ) {
		...
		$acces="y";
		if(($_SESSION['statut']=='eleve')&&($GeesAccesEleTrombiTousEleves!="yes")&&($GeesAccesEleTrombiElevesClasse!="yes")) {
			$acces="n";
		}
		...
		if((getSettingValue('active_module_trombinoscopes')=='y')&&($acces=="y")) {
			...
			if (( $classe != 'toutes' )&&($_SESSION['statut']=='eleve')&&($GeesAccesEleTrombiTousEleves=="yes")) {
				echo "<option value='toutes'>voir toutes les classes</option>\n";
			}
			...
			if (( $groupe != 'toutes' )&&($_SESSION['statut']=='eleve')&&($GeesAccesEleTrombiTousEleves=="yes")) {
				echo "<option value='toutes'>voir tous les groupes</option>\n";
			}
...
<?php
		...
		$acces="y";
		if(($_SESSION['statut']=='eleve')&&($GeesAccesEleTrombiPersonnels!="yes")&&($GeesAccesEleTrombiProfsClasse!="yes")) {
			$acces="n";
		}
		...
		if((getSettingValue('active_module_trombino_pers')=='y')&&($acces=="y")) {
			...
			if (( $equipepeda != 'toutes' )&&($_SESSION['statut']=='eleve')&&($GeesAccesEleTrombiPersonnels=="yes")) {
				echo "<option value='toutes'>voir toutes les équipes pedagogique</option>\n";
			}
			...
			//==========================================================
			// PAR DISCIPLINES
			if((($_SESSION['statut']!='eleve')||(($_SESSION['statut']=='eleve')&&($GeesAccesEleTrombiPersonnels=='yes')))&&
			...
			if ( $statusgepi == '' ) {
				if(($_SESSION['statut']=='eleve')&&($GeesAccesEleTrombiPersonnels!='yes')) {
...
if ( $etape === '2' and $classe != 'toutes' and $groupe != 'toutes' and $discipline != 'toutes' and $equipepeda != 'toutes' and ( $classe != '' or $groupe != '' or $aid != '' or $equipepeda != '' or $discipline != '' or $statusgepi != '') ) {
	...
	if ( $action_affiche === 'classe' ) {
		if($_SESSION['statut']=='eleve') {
			...
			elseif($GeesAccesEleTrombiElevesClasse=='yes') {
	...
	if ( $action_affiche === 'statusgepi' ) {
		if($_SESSION['statut']=='eleve') {
			if(($GeesAccesEleTrombiPersonnels!='yes')&&($GeesAccesEleTrombiProfsClasse=='yes')) {
