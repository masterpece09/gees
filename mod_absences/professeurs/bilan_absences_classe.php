...
<table summary="Liste des absents sur le temps demand&eacute;" id="aff_abs">
	...
	<thead><tr><th><?php echo $aff_nom_classe; ?></th><th colspan="<?php echo $nbre_de_jours; ?>">Pour chaque journ&eacute;e, Gees r&eacute;capitule le nombre d'absences qui ont &eacute;t&eacute; saisies par les professeurs.</th></tr></thead>

	<?php echo $aff_tab; ?>

	<?php echo $aff_liste_abs; ?>

	<tfoot><tr><th colspan="2">Afficher le <?php echo date("d/m/Y - h:i"); ?></th><th colspan="<?php echo $nbre_de_jours - 1; ?>">Pour chaque journ&eacute;e, Gees r&eacute;capitule le nombre d'absences qui ont &eacute;t&eacute; saisies par les professeurs.</th></tr></tfoot>
