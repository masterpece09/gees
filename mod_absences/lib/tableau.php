...
if ($type == "A" or $type == "tous")
{
	...
	$execution_div = mysqli_query($GLOBALS["mysqli"], $requete_recherche) or die('Erreur SQL !'.$requete_recherche.'<br />'.mysqli_error($GLOBALS["mysqli"]));
...
<?/* Ajout d'une possibilité de tri sur les colonnes en mode afficher  didier*/ ?>
    ...
    <?php
      ...
      $init_v = "";
      $ic = 1;
      $execution_recherche = mysqli_query($GLOBALS["mysqli"], $requete_recherche) or die('Erreur SQL !'.$requete_recherche.'<br />'.mysqli_error($GLOBALS["mysqli"]));
