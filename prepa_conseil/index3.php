...
if (isset($id_classe)) {
	...
	//echo "\getSettingValue(\"GeesAccesBulletinSimpleProfToutesClasses\")=".getSettingValue("GeesAccesBulletinSimpleProfToutesClasses")."<br />";

	if ($_SESSION['statut'] == "professeur" AND getSettingValue("GeesAccesBulletinSimpleProfToutesClasses") != "yes") {
		...
		if ((getSettingValue("GeesAccesBulletinSimpleProf") == "yes")||(getSettingValue("GeesAccesBulletinSimpleProfTousEleves") == "yes")) {
...
if (
	($_SESSION['statut'] == "responsable" AND getSettingValue("GeesAccesBulletinSimpleParent") != "yes") OR
	($_SESSION['statut'] == "eleve" AND getSettingValue("GeesAccesBulletinSimpleEleve") != "yes")
	) {
	echo "<p class=\"bold\"><a href=\"../accueil.php\"><img src='../images/icons/back.png' alt='Retour' class='back_link'/> Retour accueil</a>";
...
if (!isset($id_classe) and $_SESSION['statut'] != "responsable" AND $_SESSION['statut'] != "eleve") {
	...
	//elseif(($_SESSION['statut'] == 'professeur')&&(getSettingValue("GeesAccesReleveProf")=='yes')){
	elseif($_SESSION['statut'] == 'professeur' and getSettingValue("GeesAccesBulletinSimpleProfToutesClasses") != "yes"){
		...
		elseif(getSettingValue("GeesAccesBulletinSimplePP") == "yes") {
	...
	//elseif(($_SESSION['statut'] == 'cpe')&&(getSettingValue("GeesAccesReleveCpe")=='yes')){
	...
	if ($_SESSION['statut'] != "responsable" and $_SESSION['statut'] != "eleve") {
		...
		if((getSettingAOui('GeesAccesPPTousElevesDeLaClasse'))&&(is_pp($_SESSION['login'], $id_classe))) {
			// Tous les élèves vont être affichés
		}
		elseif ($_SESSION['statut'] == "professeur" AND getSettingValue("GeesAccesBulletinSimpleProfTousEleves") != "yes" AND getSettingValue("GeesAccesBulletinSimpleProfToutesClasses") != "yes") {
		...
		elseif ($_SESSION['statut'] == "professeur" AND getSettingValue("GeesAccesBulletinSimpleProfTousEleves") != "yes" AND getSettingValue("GeesAccesBulletinSimpleProfToutesClasses") != "yes") {
			...
			*/
			if(is_pp($_SESSION['login'], $id_classe)) {
				if(getSettingAOui('GeesAccesBulletinSimpleProf')) {
					$sql="(SELECT DISTINCT e.* " .
						"FROM eleves e, j_eleves_classes jec, j_eleves_groupes jeg, j_groupes_professeurs jgp " .
						"WHERE (" .
						"jec.id_classe='$id_classe' AND " .
		...
		if((($_SESSION['statut']=='responsable')&&(getSettingAOui('GeesAccesBulletinSimpleClasseResp')))||
			(($_SESSION['statut']=='eleve')&&(getSettingAOui('GeesAccesBulletinSimpleClasseEleve')))) {
			echo "<p>Afficher<br />\n";
...
<table class='boireaus boireaus_alt'>
	...
	// 20121118
	if(($_SESSION['statut']!='eleve')&&($_SESSION['statut']!='responsable')&&
	((getSettingAOui('GeesAccesBulletinSimpleParent'))||
