...
if ($_SESSION['statut'] == "responsable" AND $choix_edit != "2") {
	if((!getSettingAOui('GeesAccesBulletinSimpleClasseResp'))||($choix_edit != "4")) {
...
if ($_SESSION['statut'] == "eleve" AND $choix_edit != "2") {
	if((!getSettingAOui('GeesAccesBulletinSimpleClasseEleve'))||($choix_edit != "4")) {
...
getSettingValue("GeesAccesBulletinSimpleProfToutesClasses") != "yes" AND
getSettingValue("GeesAccesBulletinSimpleProfTousEleves") != "yes" AND
$choix_edit == "2") {
...
if((($_SESSION['statut']=='eleve')&&(!getSettingAOui('GeesAccesBulletinSimpleColonneMoyClasseEleve')))||
(($_SESSION['statut']=='responsable')&&(!getSettingAOui('GeesAccesBulletinSimpleColonneMoyClasseResp')))) {
...
if ($choix_edit != '2') {
	...
	if((($_SESSION['statut']=='eleve')&&(!getSettingAOui('GeesAccesBulletinSimpleColonneMoyClasseMinMaxEleve')))||
	(($_SESSION['statut']=='responsable')&&(!getSettingAOui('GeesAccesBulletinSimpleColonneMoyClasseMinMaxResp')))) {
