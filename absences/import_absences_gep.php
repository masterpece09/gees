...
if ($step == 0) {
	echo "<b>ATTENTION</b> : les élèves suivants ne disposent pas dans la base <b>GEES</b> de <b>numéro GEP</b>. Pour ces élèves, aucune donnée sur les absences ne pourra donc être importée.
	<ul>
	...
	<li>soit vous devez, avant de procéder à l'importation des absences, renseigner le numéro GEP de ces élèves en modifiant leur fiche (voir l'administrateur de GEES).</li>
	</ul>\n";
	...
	*/
	...
	sont présentes dans la base GEES. Si ces données ne sont plus exactes, vous pouvez procéder à une <b><a href='import_absences_gep.php?id_classe=$id_classe&amp;periode_num=$periode_num&amp;step=1'>nouvelle importation</a></b>.";
...
//                echo "<tr><td>$k</td>\n";
			...
			echo "<p><b>Attention </b>: les données ne sont pas encore enregistrées dans la base GEES.</p>\n";
			echo "<form enctype=\"multipart/form-data\" action=\"import_absences_gep.php\" method=\"post\" name=\"form_absences\">\n";
			echo add_token_field();
			echo "<p align=\"center\"><input type=submit value=\"Enregistrer les données dans la base GEES\" /></p>\n";
