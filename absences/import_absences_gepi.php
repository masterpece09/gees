...
//**************** EN-TETE *****************
$titre_page = "Outil d'importation des absences du module d'absence de GEES";
...
?>
      <fieldset style="width: 450px; margin: auto;" class="couleur_ligne_3">
		...
		Attention, vous allez importer les absences<br />gérées par le module absence de GEES
	    </div>
      </fieldset>
    </form>
</div>
...
<div style="text-align: center;">
	...
	<span style="font: normal small-caps normal 14pt; line-height: 125%;">Classe de <?php echo "$classe"; ?> - Importation des absences de GEES</span>
