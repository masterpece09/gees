...
if (!suivi_ariane($_SERVER['PHP_SELF'],$titre_page))
  ...
  $expli = "Visualiser les tentatives d'utilisation illégale de Gees.";
  ...
  $expli = "Voir la configuration du serveur php/Mysql pour v&eacute;rifier la compatibilit&eacute; avec Gees.";
  $ancre="test_serveur";
  $tbs_menu[$nummenu]['entree'][]=array('lien'=>$chemin , 'titre'=>$titre, 'expli'=>$expli, 'ancre'=>$ancre);
  ...
  $expli = "Sauvegarder la base GEES sous la forme d'un fichier au format \"mysql\".<br />
    Restaurer des données dans la base Mysql de GEES à partir d'un fichier.";
  $ancre="accueil_sauve";
  $tbs_menu[$nummenu]['entree'][]=array('lien'=>$chemin , 'titre'=>$titre, 'expli'=>$expli, 'ancre'=>$ancre);
  
  $chemin = "../utilitaires/maj.php";
  $titre = "Mise à jour de la base";
  $expli = "Permet d'effectuer une mise à jour de la base MySql après un changement de version  de GEES.";
  $ancre="maj";
  $tbs_menu[$nummenu]['entree'][]=array('lien'=>$chemin , 'titre'=>$titre, 'expli'=>$expli, 'ancre'=>$ancre);
  
  $chemin = "../utilitaires/clean_tables.php";
  $titre = "Nettoyage des tables";
  $expli = "Procéder à un nettoyage des tables de la base MySql de GEES (suppression de certains doublons et/ou lignes obsolètes ou orphelines).";
  $ancre="clean_tables";
  $tbs_menu[$nummenu]['entree'][]=array('lien'=>$chemin , 'titre'=>$titre, 'expli'=>$expli, 'ancre'=>$ancre);
