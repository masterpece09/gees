...
(cahier de textes, absences,...)">
	...
	<p class="ligneCaps">
		<label for='gepiPrefixeSujetMail' class="cellTab70">
			Ajouter un préfixe au sujet des mails envoyés par Gees :<br />
			<span class="plusPetit">Cela peut être utile si vous recevez des mails de plusieurs Gees.<br />
			Notez que le préfixe 'GEES :' est de toutes façons ajouté.</span>
		</label>
		<span class="cellTab plusPetit">
	...
	<p class="ligneCaps">
		<label for='sessionMaxLength' class="cellTab70">
			...
			<span class='small'>(<em>Durée d'inactivité, en minutes, au bout de laquelle un utilisateur est automatiquement déconnecté de Gees.</em>) <b>Attention</b>, la variable <b>session.maxlifetime</b> dans le fichier <b>php.ini</b> est réglée à <?php 
	...
	<div style="display: table-row;">
		<div class="cellTab70">
			<p style="font-variant: small-caps;">
				...
				Mode d'ouverture des fichiers PDF produits par Gees&nbsp;:
			</p>
		</div>
		<p class="cellTab plusPetit">
<?php
...
if(!in_array($output_mode_pdf, array("D", "I"))) {$output_mode_pdf='D';}
 ?>
	...
	<p class="ligneCaps">
		<span class="cellTab70">
			<label for='url_racine_gepi' style='cursor: pointer'>Adresse de la racine Gees</label>
			<br />
			<span class='small'>
				(<em>utilisé dans des envois de mails pour donner l'adresse d'une page en particulier<br />
				Exemple&nbsp;: https://NOM_SERVEUR/DOSSIER_GEES</em>)&nbsp;:</label>
			</span>
		</span>
		<span class="cellTab plusPetit">
			<?php
	...
	<p class="ligneCaps">
		<span class="cellTab70">
			...
			<span class='small'>
				...
				installation de GEES doit faire l'objet d'une déclaration de traitement automatisé d'informations nominatives 
...
?>
	...
	<p  class="cellTab" style="font-variant: small-caps;">
		Tester la date de la révision Gees avec git<br />(<em>nécessite que git soit installé et accessible</em>) :
	</p>
	<p class="cellTab">
		<input type="radio" 
	...
	<p>
		git est l'outil de gestion de versions de Gees.<br />
		...
		Cela peut être commode pour apporter des précisions sur votre version quand vous posez une question sur la liste gepi-users, mais l'absence éventuelle de git n'enlèvera aucune fonctionnalité à votre Gees.
	</p>
</fieldset>
</form>
...
?>
	...
	<p  class="cellTab" style="font-variant: small-caps;">
		Gees en production<br />(<em>par opposition à un Gees de test</em>)&nbsp;:
	</p>
	<p class="cellTab">
		<input type="radio" 
	...
	<p>
		Sur un serveur Gees en production, avec des données que l'on ne veut pas perdre accidentellement, on désactive l'accès à quelques liens sensibles de Gees comme <strong>Effacer la base</strong> et <strong>Données de test</strong>.<br />
		Sur un Gees de test en revanche, on peut souhaiter effectuer ces actions sensibles.
	</p>
</fieldset>
</form>
	...
	<p class="ligneCaps" style="font-variant: small-caps;">
		Activer le debug PHPMailer&nbsp;:<br />
			<span class='small'>
				...
				Cette activation va polluer les affichages dans Gees<br />avec un grand nombre de lignes chaque fois qu'un mail est envoyé.<br />
