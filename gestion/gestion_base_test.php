...
if(getSettingAOui('gepi_en_production')) {
    ...
    echo "<p>Votre serveur Gees est paramétré comme un serveur en production.<br />Vous ne devriez pas charger des données de test (<em>cela polluerait votre base avec des données qui n'ont rien à voir avec celles de votre établissement</em>).</p>\n";
    echo "<p>Vous pouvez modifier ce paramétrage dans la page de <a href='param_gen.php#gepi_en_production'>Configuration générale</a> si votre Gees est en fait juste un Gees de test.</p>\n";
