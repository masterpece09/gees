...
echo "<br />";
echo "<p>Lors de la création d'un utilisateur, il vous est possible d'imprimer une feuille d'information contenant les paramètres de connexion à GEES, le texte diffère selon le statut de l'utilisateur créé. Attention, ce texte est au format html !</p>\n";
...
if($fiche=="responsables") {
	...
	if(getSettingValue('GeesAdminImprBulSettings')=='yes') {
