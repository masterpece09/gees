...
<h1 class='gepi'>GEES - Informations générales</h1>

<?php

echo "Vous êtes actuellement connecté sur l'application <b>GEES (".getSettingValue("gepiSchoolName").")</b>.
...
echo "<h2>Administration de l'application GEES</h2>\n";
...
echo "<h2>Objectifs de l'application GEES</h2>\n";

echo "L'objectif de GEES est la <b>gestion pédagogique des élèves et de leur scolarité</b>.
...
if (getSettingValue("active_cahiers_texte")=='y') {
    ...
    echo "Conformément aux directives de l'Education Nationale, chaque professeur dispose dans GEES d'un cahier de texte pour chacune de ses classes qu'il peut tenir à jour
...
if (getSettingValue("active_carnets_notes")=='y') {
    ...
    echo "Chaque professeur dispose dans GEES d'un carnet de notes pour chacune de ses classes, qu'il peut tenir à jour
    ...
    Ces données stockées dans GEES n'ont pas d'autre destinataire que le professeur lui-même et le ou les professeurs principaux de la classe.
...
if ($test_plugin=='y') {
    ...
    echo "Chaque professeur dispose dans GEES d'un outil de suivi des élèves (\"observatoire\") pour chacune de ses classes, qu'il peut tenir à jour
    ...
    Ces codes et leur signification sont paramétrables par les administrateurs de l'observatoire désignés par l'administrateur général de GEES.
    ...
    <br /><br />Dans le respect de la loi informatique et liberté 78-17 du 6 janvier 1978, chaque élève a également accès dans son espace GEES aux données qui le concernent";
