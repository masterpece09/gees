...
<p>
	Configuration de GEES de manière à bloquer temporairement le compte d'un utilisateur après un certain nombre de tentatives 
...
<p>
	...
	sous réserve que leur adresse mail soit renseignée dans Gees (<em>information modifiable par le lien 'Gérer mon compte'</em>).
	<br />
...
<p>
	...
	sur votre GEES est: <span style='font-weight:bold'><?php echo $active_hostbyaddr; ?></span></p>
</div>
