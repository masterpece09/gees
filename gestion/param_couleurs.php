...
// INSERT INTO droits VALUES ('/gestion/param_couleurs.php', 'V', 'F', 'F', 'F', 'F', 'F', 'F', 'Définition des couleurs pour Gees', '');
if (!checkAccess()) {
    header("Location: ../logout.php?auto=1");
    die();
}
...
//**************** EN-TETE *****************
$titre_page = "Couleurs et Modèles GEES";
...
<p>Définissez les couleurs pour l'interface GEES et gérez vos modèles.
