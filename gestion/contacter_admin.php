...
?>
<h1 class='gepi'>GEES - Obtenir de l'aide de l'administrateur.</h1>
<?php

$objet_msg=isset($_POST['objet_msg']) ? $_POST['objet_msg'] : "Demande d'aide dans GEES";
if($objet_msg=='') {
...
case "envoi":
	...
	$message = "Demande d'aide depuis GEES :\n";
	...
	//if($objet_msg=='') {$objet_msg="Demande d'aide dans GEES";}
...
default://formulaire d'envoi
	...
	<p>Sujet&nbsp;<span style='color:red' alt='Ce champ doit être renseigné' title='Ce champ doit être renseigné'>(*)</span>&nbsp;: <!--input type='text' name='objet_msg' value="Demande d'aide dans GEES" size='35' maxlength='80' /--><input type='text' name='objet_msg' id='objet_msg' value="" size='35' maxlength='80' /><br />
