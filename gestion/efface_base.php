...
if(getSettingAOui('gepi_en_production')) {
    ...
    echo "<p>Votre serveur Gees est paramétré comme un serveur en production.<br />Vous ne devriez pas effacer la base.<br />Vous perdriez tout ce qui est actuellement dans la base Gees sauf&nbsp;:</p>
<ul>
