...
function lien_envoi_mail_rappel($id_sanction, $num, $id_incident="") {
	...
	if(($id_sanction!="")||($id_incident!="")) {
		...
		if($id_sanction=="") {
			...
			$retour.="<input type='hidden' name='sujet_mail_rappel_$num' id='sujet_mail_rappel_$num' value=\"[GEES] Discipline : Demande de travail pour une ".$mod_disc_terme_sanction."\" />\n";
			...
			if(mysqli_num_rows($res)>0) {
				...
				$mail_declarant = retourne_email($login_declarant);
				//echo add_token_field(true);
				$retour.="<input type='hidden' name='sujet_mail_rappel_$num' id='sujet_mail_rappel_$num' value=\"[GEES] Discipline : Demande de travail pour une $lig_sanction->nature\" />\n";
				$retour.="<input type='hidden' name='destinataire_mail_rappel_$num' id='destinataire_mail_rappel_$num' value=\"".$mail_declarant."\" />\n";
