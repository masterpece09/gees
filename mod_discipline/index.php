...
if(($_SESSION['statut']=='administrateur')||
	(($_SESSION['statut']=='cpe')&&(
			(getSettingAOui('GeesDiscDefinirLieuxCpe'))||
			(getSettingAOui('GeesDiscDefinirRolesCpe'))||
			(getSettingAOui('GeesDiscDefinirMesuresCpe'))||
			(getSettingAOui('GeesDiscDefinirSanctionsCpe'))||
			(getSettingAOui('GeesDiscDefinirNaturesCpe'))||
			(getSettingAOui('GeesDiscDefinirCategoriesCpe'))||
			(getSettingAOui('GeesDiscDefinirDestAlertesCpe'))
		)
	)||
	(($_SESSION['statut']=='scolarite')&&(
			(getSettingAOui('GeesDiscDefinirLieuxScol'))||
			(getSettingAOui('GeesDiscDefinirRolesScol'))||
			(getSettingAOui('GeesDiscDefinirMesuresScol'))||
			(getSettingAOui('GeesDiscDefinirSanctionsScol'))||
			(getSettingAOui('GeesDiscDefinirNaturesScol'))||
			(getSettingAOui('GeesDiscDefinirCategoriesScol'))||
			(getSettingAOui('GeesDiscDefinirDestAlertesScol'))
		)
	)
) { 
/* ===== Titre du menu ===== */
...
*/
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		$acces_ok="n";
		if(($_SESSION['statut']=='administrateur')||
		(($_SESSION['statut']=='cpe')&&(getSettingAOui('GeesDiscDefinirLieuxCpe')))||
		(($_SESSION['statut']=='scolarite')&&(getSettingAOui('GeesDiscDefinirLieuxScol')))) {
			$acces_ok="y";
...
*/
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		$acces_ok="n";
		if(($_SESSION['statut']=='administrateur')||
		(($_SESSION['statut']=='cpe')&&(getSettingAOui('GeesDiscDefinirRolesCpe')))||
		(($_SESSION['statut']=='scolarite')&&(getSettingAOui('GeesDiscDefinirRolesScol')))) {
			$acces_ok="y";
...
*/
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		$acces_ok="n";
		if(($_SESSION['statut']=='administrateur')||
		(($_SESSION['statut']=='cpe')&&(getSettingAOui('GeesDiscDefinirMesuresCpe')))||
		(($_SESSION['statut']=='scolarite')&&(getSettingAOui('GeesDiscDefinirMesuresScol')))) {
			$acces_ok="y";
...
*/
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		$acces_ok="n";
		if(($_SESSION['statut']=='administrateur')||
		(($_SESSION['statut']=='cpe')&&(getSettingAOui('GeesDiscDefinirSanctionsCpe')))||
		(($_SESSION['statut']=='scolarite')&&(getSettingAOui('GeesDiscDefinirSanctionsScol')))) {
			$acces_ok="y";
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		$acces_ok="n";
		if(($_SESSION['statut']=='administrateur')||
		(($_SESSION['statut']=='cpe')&&(getSettingAOui('GeesDiscDefinirNaturesCpe')))||
		(($_SESSION['statut']=='scolarite')&&(getSettingAOui('GeesDiscDefinirNaturesScol')))) {
			$acces_ok="y";
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		$acces_ok="n";
		if(($_SESSION['statut']=='administrateur')||
		(($_SESSION['statut']=='cpe')&&(getSettingAOui('GeesDiscDefinirCategoriesCpe')))||
		(($_SESSION['statut']=='scolarite')&&(getSettingAOui('GeesDiscDefinirCategoriesScol')))) {
			$acces_ok="y";
...
*/
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		$acces_ok="n";
		if(($_SESSION['statut']=='administrateur')||
		(($_SESSION['statut']=='cpe')&&(getSettingAOui('GeesDiscDefinirDestAlertesCpe')))||
		(($_SESSION['statut']=='scolarite')&&(getSettingAOui('GeesDiscDefinirDestAlertesScol')))) {
			$acces_ok="y";
...
/* ===== Titre du menu ===== */
$mod_disc_acces_avertissements=getSettingValue('mod_disc_acces_avertissements');
if($mod_disc_acces_avertissements!="n") {
