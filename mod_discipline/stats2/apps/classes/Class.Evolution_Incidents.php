...
class ClassEvolution_Incidents extends ClassIncidents {
  ...
  private function traite_evolution_categories($filtres_roles=Null,$filtres_categories=Null,$filtres_mesures=Null,$filtres_sanctions=Null) {
    ...
    foreach($this->months as $key=>$month) {
      ...
      $this->data_months=Gees_Date::get_begin_end_month($key);
      $this->objet_incident->traite_incidents_criteres(Gees_Date::format_date_fr_iso($this->data_months['du']),Gees_Date::format_date_fr_iso( $this->data_months['au']), $filtres_categories,$filtres_mesures,$filtres_sanctions,$filtres_roles);
