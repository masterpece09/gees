...
class BilansCtrl extends Controleur {
  ...
  private function traite_incidents_bilans() {
    ...
    $this->objet_incidents->traite_incidents_criteres(Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['du']),Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['au']),$this->filtres_categories,$this->filtres_mesures,$this->filtres_sanctions,$this->filtres_roles);
  ...
  public function top() {
    try {
      ...
      $this->traite_filtres();
      $this->objet_incidents= new ClassIncidents();
      $this->top_incidents=$this->objet_incidents->get_top_incidents(Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['du']),Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['au']),$this->filtres_categories,$this->filtres_mesures,$this->filtres_sanctions,$this->filtres_roles);
      $this->vue->setVar('top_incidents', $this->top_incidents);
      $this->top_sanctions=$this->objet_incidents->get_top_sanctions(Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['du']),Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['au']),$this->filtres_categories,$this->filtres_mesures,$this->filtres_sanctions,$this->filtres_roles);
      $this->vue->setVar('top_sanctions', $this->top_sanctions);
      $this->top_retenues=$this->objet_incidents->get_top_retenues(Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['du']),Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['au']),$this->filtres_categories,$this->filtres_mesures,$this->filtres_sanctions,$this->filtres_roles);
      $this->vue->setVar('top_retenues', $this->top_retenues);
      $this->top_exclusions=$this->objet_incidents->get_top_exclusions(Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['du']),Gees_Date::format_date_fr_iso($_SESSION['stats_periodes']['au']),$this->filtres_categories,$this->filtres_mesures,$this->filtres_sanctions,$this->filtres_roles);
