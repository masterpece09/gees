						...
						if(mysqli_num_rows($res_jec)==1){
							...
							while($lig_grp=mysqli_fetch_object($res_jeg)){
								...
								if(mysqli_num_rows($res_test_grp_clas)==0){
									...
									$info="il faudra effectuer un <a href='clean_tables.php?maj=9".add_token_in_url()."'>nettoyage des tables de la base de données GEES</a> (<i>après une <a href='../gestion/accueil_sauve.php?action=";
