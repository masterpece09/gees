 ...
 */
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesReleveEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesReleveEleve', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesCahierTexteEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesCahierTexteEleve', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesReleveParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesReleveParent', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesCahierTexteParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesCahierTexteParent', 'yes');");
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesPasswordReinitProf'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesPasswordReinitProf', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesPasswordReinitScolarite'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesPasswordReinitScolarite', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesPasswordReinitCpe'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesPasswordReinitCpe', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesPasswordReinitAdmin'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesPasswordReinitAdmin', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesPasswordReinitEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesPasswordReinitEleve', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesPasswordReinitParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesPasswordReinitParent', 'yes');");
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesEquipePedaEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesEquipePedaEleve', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesEquipePedaEmailEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesEquipePedaEmailEleve', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesCpePPEmailEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesCpePPEmailEleve', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesEquipePedaParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesEquipePedaParent', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesEquipePedaEmailParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesEquipePedaEmailParent', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesCpePPEmailParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesCpePPEmailParent', 'no');");
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesBulletinSimpleEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesBulletinSimpleEleve', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesBulletinSimpleParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesBulletinSimpleParent', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesBulletinSimpleProf'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesBulletinSimpleProf', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesBulletinSimpleProfTousEleves'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesBulletinSimpleProfTousEleves', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesBulletinSimpleProfToutesClasses'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesBulletinSimpleProfToutesClasses', 'no');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesReleveProfTousEleves'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesReleveProfTousEleves', 'yes');");
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesMoyennesProf'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesMoyennesProf', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesMoyennesProfTousEleves'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesMoyennesProfTousEleves', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesMoyennesProfToutesClasses'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesMoyennesProfToutesClasses', 'yes');");
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesGraphEleve'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesGraphEleve', 'yes');");

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesGraphParent'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0)
		$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesGraphParent', 'yes');");
