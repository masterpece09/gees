...
$test = sql_query1("SELECT 1=1 FROM setting WHERE name='GeesPeutCreerBoitesProf'");
if ($test == -1) {
	$result_inter = traite_requete("INSERT INTO setting SET name='GeesPeutCreerBoitesProf', value='yes';");
	if ($result_inter == '') {
		$result .= msj_ok("SUCCES !");
	}
	else {
