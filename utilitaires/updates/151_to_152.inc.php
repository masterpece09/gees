...
lieu VARCHAR( 255 ) NOT NULL
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesCahierTexteVersion'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0) {
			$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesCahierTexteVersion', '1');");
		}
		...
		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesSaisieEctsPP'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0) {
			$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesSaisieEctsPP', 'no');");
		}

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesSaisieEctsScolarite'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0) {
			$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesSaisieEctsScolarite', 'yes');");
		}

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesEditionDocsEctsPP'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0) {
			$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesEditionDocsEctsPP', 'no');");
		}

		$req_test = mysqli_query($GLOBALS["mysqli"], "SELECT VALUE FROM setting WHERE NAME = 'GeesAccesEditionDocsEctsScolarite'");
		$res_test = mysqli_num_rows($req_test);
		if ($res_test == 0) {
			$result_inter .= traite_requete("INSERT INTO setting VALUES ('GeesAccesEditionDocsEctsScolarite', 'yes');");
		}
    ...
    $result .= "&nbsp;->Ajout d'un setting sur l'utilisation unique du cahier de textes de Gees<br />";
