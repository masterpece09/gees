...
?>
    ...
    <TITLE>Mise à jour spéciale de la base de donnée GEES</TITLE>
...
if (($resultat_session == '0') and ($valid!='yes')) {
    ...
    <div class="center">
    <H2 align="center"><?php echo "Mise à jour spéciale de la base de donnée GEES<br />(Accès administrateur)"; ?></H2>
...
if ((isset($_SESSION['statut'])) and ($_SESSION['statut'] != 'administrateur')) {
   echo "<center><p class=grand><font color=red>Mise à jour spéciale de la base MySql de GEES.<br />Vous n'avez pas les droits suffisants pour accéder à cette page.</font><p></center></body></html>";
   die();
}
...
echo "<center><p class=grand>Mise à jour spéciale de la base de données MySql de GEES<p></center>";
if (isset($message)) {
    if ($message == '') {
    ...
    à la présence dans certains identifiants d'élèves du caractère \"-\".
    <br><br>Si vous avez utilisé la procédure d'initialisation des bases de GEES à partir des
    fichiers GEP avec une version de GEES antérieure à la version 1.3, il se peut que certains identifiants d'élèves
