...
if (getSettingValue("rss_cdt_eleve") == "y" AND $genereflux == "y") {
	...
	$result .= '<p>Gees vérifie si la table nécessaire est bien dans la base.</p>';
...
<h3>Cet outil permet d'autoriser la g&eacute;n&eacute;ration de flux <acronym title="Appel&eacute; aussi syndication">rss</acronym> 2.0 des cahiers de textes de Gees. </h3>
...
<form name="form_rss_ele" action="rss_cdt_admin.php" method="post">
	<p>
		...
		<label for="rssAccesEle">Les &eacute;l&egrave;ves r&eacute;cup&egrave;rent l'adresse (url) d'abonnement directement par leur acc&egrave;s &agrave; Gees</label>
	</p>
	<p>
