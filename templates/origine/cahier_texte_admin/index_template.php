  ...
  ?>
	  ...
	  <fieldset class="no_bordure">
		...
		<input type="radio"
				 ...
				 value="1"
			 onchange='changement();'
				<?php if (getSettingValue("GeesCahierTexteVersion")=='1') echo " checked='checked'"; ?> />
		...
		<br />
		  <input type="radio"
				 ...
				 value="2"
			 onchange='changement();'
				<?php if (getSettingValue("GeesCahierTexteVersion")=='2') echo " checked='checked'"; ?> />
	  ...
	  <p class="italic">
		...
		<br />
		L'édition (<em>modification/suppression/ajout</em>) des cahiers de textes par les utilisateurs de GEES
...
?>
	...
	<ul>
	  ...
	  <li><a href='../cahier_texte_admin/suppr_docs_joints_cdt.php'>Suppression des documents joints aux CDT</a></li>
	...
	<h2>Astuce</h2>
	<p>
	  Si vous souhaitez n'utiliser que le module Cahier de textes dans Gees, consultez la page suivante&nbsp;:
	  <br />
