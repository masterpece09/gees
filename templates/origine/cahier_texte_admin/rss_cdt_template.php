...
<!-- Fin haut de page -->
  ...
  <p class="bold">
	...
	2.0 des cahiers de textes de Gees. 
  </p>
...
?>
		...
		<label for="rssAccesEle">
		  Les élèves (<em>et/ou responsables selon ce qui est coché ci-dessus</em>) récupèrent l'adresse (<em>url</em>) d'abonnement directement par leur accès à Gees
		</label>
		<br />
...
?>
		...
		<label for="rss_email_mode_adm">
			Utiliser l'email de l'administrateur GEES (<em><?php echo getSettingValue('gepiAdminAdress');?></em>)
		</label>
		<br />
