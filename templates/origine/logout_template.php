...
if (my_eregi("msie",$agent) && !my_eregi("opera",$agent)) {
	...
	echo "<br/>Si vous subissez des déconnexions intempestives, si vous n'arrivez pas à vous connecter à Gees, " .
			"ou bien s'il vous faut répéter plusieurs fois la procédure de connexion avant de pouvoir accéder aux outils de Gees, " .
			...
			"qui vous garantira les meilleures conditions d'utilisation de Gees.</p>";
	echo "</div>";
}
?>
