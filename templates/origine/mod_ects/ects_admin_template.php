...
<!-- Fin haut de page -->
  ...
  <p>
	<em>
	  La désactivation du module ECTS n'entraîne aucune suppression des données. 
	  Lorsque le module est désactivé, il n'est plus possible de gérer les valeurs d'ECTS pour les enseignements 
	  ou de saisir des ECTS pour les élèves.
	</em>
  </p>
