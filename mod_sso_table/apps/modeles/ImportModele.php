...
class ImportModele {
  ...
  public function cree_table_import() {
    ...
    $this->req = " CREATE TABLE `sso_table_import` (
					...
					`login` varchar(50) COMMENT 'login de Gees',
  ...
  /**
   * Recherche le login d'un utilisateur responsable en utilisant son enfant pour le retrouver dans Gees (traitement des doublons)
  ...
  /**
   * On récupère les utilisateurs de Gees sans correspondance dans la table
   */
