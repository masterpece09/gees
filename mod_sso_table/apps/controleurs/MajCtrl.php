...
class MajCtrl extends Controleur {
  ...
  function search () {         
    try {
      ...
      if(!$this->search_result)throw new exception("Aucun utilisateur correspondant à vos critères de recherche n'existe dans Gees avec son compte paramétré en sso");
