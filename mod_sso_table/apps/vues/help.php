...
<h2>Ce module sert à créer une correspondance entre les logins Gees et ENT dans le cas d'une authentification CAS</h2>
...
<ol>
	...
	<p>La première donnée est le login Gees et la deuxième le login sso (de l'ent par exemple)</p>
	...
	<p>Si l'utilisateur n'existe pas dans Gees , ou si une entrée existe déja dans la table de correspondance (login Gees ou sso),
	aucune correspondance n'est mis en place.</p>
	<p>Si l'utilisateur existe dans Gees mais que le compte n'est pas paramétré en sso la correspondance est mise en place mais le mode de connexion doit être modifié dans Gees </p>
	<p>Dans les autres cas la correspondance est mise en place.</p>
	<br />

	<li><a name='maj'></a><strong>Par mise en place manuelle de la correspondance pour un utilisateur de Gees :</strong></li>
	<p>Cliquer sur <em>Mise à jour de données </em></p>
	<p>Rechercher le nom d'un utilisateur de Gees </p>
	...
	<p>Vous pouvez entrer le login sso pour la correspondance avec Gees.</p>
	...
	<ol>
	  ...
	  <li>profil : sert à différencier les doublons parents et élèves, les intitulés peuvent être différents de ceux de Gees mais doivent être cohérents</li>
	  <li>prénom : le premier doit correspondre à celui de Gees</li>
	  <li>nom : doit correspondre à celui de Gees</li>
	...
	<p>Une fois le traitement effectué vous obtiendrez un tableau avec les résultats :</p>
	<img src='img/resultat.png' />
	<p>Si l'utilisateur n'existe pas dans Gees, aucune correspondance n'est mise en place.</p>
