...
<table width="80%" border="1" align="center" cellpadding="2" cellspacing="0">
    <tr bgcolor="#CACACA">
        <td width="20%"><strong>Login Gees</strong></td>
        <td width="20%"><strong>Login sso</strong></td>
        <td width="60%"><strong>Résultat</strong></td>
        <td width="60%"><strong title="Supprimer pour le login Gees indiqué la correspondance SSO existante de la table 'sso_table_correspondance'">Supprimer</strong></td>
    </tr>
    <tr bgcolor="#F0F0F0">
        <td>[b1.login_gepi]</td>
