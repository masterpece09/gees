...
<div>[onload;block=div; when [var.choix_info]='avertissement_anciens_comptes']
  ...
  <table width="70%" border="1" align="center" cellpadding="2" cellspacing="0">
    <tr bgcolor="#CACACA">
      <td width="20%"><strong>Logins Gees n'ayant pas de compte utilisateurs dans l'application</strong></td>
    </tr>
    <tr bgcolor="#F0F0F0">
...
<div>[onload;block=div; when [var.choix_info]='supp_anciens_comptes']
  ...
  <table width="70%" border="1" align="center" cellpadding="2" cellspacing="0">
    <tr bgcolor="#CACACA">
      <td width="40%"><strong>Logins Gees n'ayant pas de compte utilisateurs dans l'application</strong></td>
