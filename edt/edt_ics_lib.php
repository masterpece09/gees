...
// Les couleurs sont dans l'EDT classique Gees définies dans templates/DefaultEDT/css/style_edt.css avec des .cadreCouleur1, .cadreCouleur2,...
...
<div id='div_edt_".$chaine_alea."'>";
		...
		// L'exclusion ne fonctionne que si toutes les matières des ICS ont bien été associées à des matières Gees.
...
function travaux_a_faire_cdt_jour($login_eleve, $id_classe) {
	...
	if(($delai=="")||($delai==0)||(!preg_match("/^[0-9]{1,}$/", $delai))) {
		$html.="<p style='margin-left:4em; text-indent:-4em; color:red'>Erreur&nbsp;: Délai de visualisation du travail personnel non défini.<br />Contactez l'administrateur de GEES de votre établissement.</p>";
		$delai=1;
	}
