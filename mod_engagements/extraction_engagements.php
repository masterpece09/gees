...
echo "
		...
		<p>
			...
			<input type='radio' name='action' id='action_message' value='message' onchange=\"checkbox_change('action_export_csv');checkbox_change('action_message');\" /><label for='action_message' id='texte_action_message'>Déposer un message dans le Panneau d'affichage Gees</label><br />
			Texte du message&nbsp;:";
