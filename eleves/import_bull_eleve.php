...
elseif(isset($_POST['Recherche_sans_js'])) {
	...
	if(!isset($_FILES["csv_file"])) {
		...
		echo "<p><i>Attention</i>&nbsp;: Veillez à n'importer que des fichiers CSV générés par Gees.<br />Dans le doute, faites une sauvegarde préalable de la base.</p>\n";
	}
	else {
