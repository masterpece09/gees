...
if (!isset($is_posted)) {
    ...
    l'identifiant <b>GEES</b> de chaque élève. Vous pouvez télécharger :
    <ul>
    <li>le fichier élèves des identifiants GEES (<i>sans les nom et prénom</i>) en
    ...
    //echo ", ou bien,";
    echo "<li>ou bien le fichier élèves (nom - prénom - identifiant GEES) en
