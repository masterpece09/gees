...
if (isset($_POST['is_posted'])) {
	...
	if (($periode_num < $nb_periode) and ($periode_num > 0) and ($ver_periode[$periode_num] != "O"))  {
		...
		elseif(($_SESSION['statut'] == 'cpe')&&(!getSettingAOui('GeesRubConseilCpeTous'))) {
