...
//if ($_SESSION['statut'] == "professeur" AND getSettingValue("GeesAccesMoyennesProfToutesClasses") != "yes" AND getSettingValue("GeesAccesMoyennesProfTousEleves") != "yes" and $choix_edit == "2") {
