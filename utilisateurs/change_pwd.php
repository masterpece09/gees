...
if ($auth_mode != "gepi" && $gepiSettings['ldap_write_access'] != "yes" && !getSettingAOui('autoriser_sso_password_auth')) {
    echo "Vous ne pouvez pas changer le mot de passe des utilisateurs lorsque Gees est configuré pour utiliser une authentification extérieure et que vous n'avez pas accès à l'annuaire LDAP en écriture.";
    echo "</div>\n";
    echo "</body></html>\n";
    die();
}
