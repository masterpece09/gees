...
//**************** FIN EN-TETE *****************
echo "<p>Le tableau suivant indique quelles fonctions de GEES sont accessibles aux utilisateurs connectés selon leur statut (administrateur, professeur, C.P.E., scolarité, ou secours).";
echo "<br />Le symbole * signale que l'accès à la fonction est configurable.<br /><br />";
echo "<b>Astuce</b> : Le statut visiteur n'existe pas dans GEES. Mais on obtient un résultat équivalent en affectant à un utilisateur le statut professeur sans affectation de matières ni de classe.<br /><br /></p>";
