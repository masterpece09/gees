...
<br/><br/>
<p>Sur cette page, vous pouvez gérer les comptes d'accès des utilisateurs ayant accès à Gees grâce à un identifiant et un mot de passe.</p>
...
<!--p class='small'><a href="import_prof_csv.php">Télécharger le fichier des professeurs au format csv</a>  (nom - prénom - identifiant GEES)</p-->
<p class='small'>Télécharger au format csv (<i>nom - prénom - identifiant GEES - EMAIL</i>) le fichier des 
