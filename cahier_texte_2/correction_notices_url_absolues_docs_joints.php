...
<p>Il peut arriver que des adresses de documents joints aux cahiers de textes soient enregistrées avec un chemin absolu (<em>du type https://NOM_SERVEUR/CHEMIN_GEES/documents/cl1234/document_XXXX.pdf ou https://IP_SERVEUR/CHEMIN_GEES/documents/cl1234/document_XXXX.pdf</em>) alors qu'une adresse relative (<em>du type ../documents/cl1234/document_XXXX.pdf</em>) est préférable dans le cas d'un serveur en DMZ publique, mais aussi pour l'archivage et également en cas de déplacement du Gees sur un autre serveur.</p>
...
<form enctype=\"multipart/form-data\" action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">
	...
	echo "
		...
		&nbsp;&nbsp;&nbsp;<strong>https://NOM_SERVEUR/CHEMIN_GEES/documents/cl1234/document_XXXX.pdf</strong><br />
		en<br />
		&nbsp;&nbsp;&nbsp;<strong>../documents/cl1234/document_XXXX.pdf</strong>,<br />
		proposez le préfixe suivant&nbsp;:<br />
		&nbsp;&nbsp;&nbsp;<strong>https://NOM_SERVEUR/CHEMIN_GEES</strong></p>
