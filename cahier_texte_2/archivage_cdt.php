...
Cela ne devrait pas arriver sauf si votre Gees était auparavant en 'multisite' et qu'il ne l'est plus.<br />
...
if(!isset($step)) {
	...
	if($step==1) {
		...
		// 1. Se prémunir de modifications de styles dans des versions ultérieures de Gees
