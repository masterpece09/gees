...
VALUES (
NULL , 'Interface de GEES', 'origine', 'n'
);
...
// Vérification de la bonne installation de GEES
...
//Message
	if (isset($message)) {
		...
		$tbs_message[] =array("classe"=>"","texte" => "Afin d'utiliser Gees, vous devez vous identifier.");
	}
...
//	Demande de compte/mot de passe
	...
	if (getSettingAOui("GeesResp_obtenir_compte_et_motdepasse")) {
