...
(($_SESSION['statut']=='scolarite')&&(getSettingAOui('OOoUploadScolNotanet')))) {
    //Fiches brevet
    $lien_wiki[]='http://www.sylogix.org/projects/gepi/wiki/GeesDoc_fbOooCalc#Gabarits-de-fiches-brevets-dautres-acad%C3%A9mies';
...
echo "</p>\n";
echo "<br />\n";
echo "<p>Ce module est destiné à gérer les modèles Open Office de Gees.</p>\n";
echo "</p>\n";
echo "<br />\n";
...
if (!isset($btn)) { //premier passage : formulaire
    echo "<p >Un modèle personnalisé, envoyé sur le serveur sera utilisé par Gees</p><hr>\n";
    ...
    echo "C'est pourquoi il est recommandé, dans ce cas là, de se limiter a des modifications simple (nature du texte par exemple) du modèle de base proposé dans Gees.<br /><br />\n";
