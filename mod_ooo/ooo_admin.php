...
if (!($resultat_mkdir)) {
  ...
  /mod_ooo/$nom_dossier_modeles_ooo_mes_modeles sont incorrects. Gees doit avoir les droits de création
...
if (!($resultat_mkdir)) {
  $droitRepertoire[]="ATTENTION : Les droits d'écriture sur le dossier /mod_ooo/tmp/ sont incorrects.
	Gees doit avoir les droits de création de dossiers et de fichiers dans ce dossier pour assurer
