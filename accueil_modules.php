...
$expli[] = "Pour gérer l'ouverture de l'emploi du temps de Gees.";
...
$expli[] = "Gestion des flux rss des cahiers de textes produits par Gees";
...
$expli[] = "Pour gérer les modèles Open Office de Gees.";
...
// Emploi du temps
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		...
		$nouveauItem->expli="Pour gérer l'ouverture de l'emploi du temps de Gees." ;
		$menuPage[]=$nouveauItem;
	}
	unset($nouveauItem);
...
// Flux rss
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		...
		$nouveauItem->expli="Gestion des flux rss des cahiers de textes produits par Gees" ;
		$menuPage[]=$nouveauItem;
	}
	unset($nouveauItem);
...
//Module modèle Open_Office
	...
	if ($nouveauItem->acces($nouveauItem->chemin,$_SESSION['statut']))
	{
		...
		$nouveauItem->expli="Pour gérer les modèles openDocument (libreOffice/openOffice) de Gees." ;
		$menuPage[]=$nouveauItem;
	}
	unset($nouveauItem);
