...
/**
 * Base static class for performing query and update operations on the 'plugins' table.
 *
 * Liste des plugins installes sur ce Gees
 *
...
abstract class BasePlugInPeer {
	...
	const NOM = 'plugins.NOM';

	/** the column name for the REPERTOIRE field */
	const REPERTOIRE = 'plugins.REPERTOIRE';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'plugins.DESCRIPTION';
	...
	/**
	 * Deletes all rows from the plugins table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += PlugInPeer::doOnDeleteCascade($c, $con);
