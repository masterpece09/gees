...
// nous insérons les informations dans la base du GEES installé
if($etape==='2') {
...
<html lang="fr">
<head>
<title>Référencement de GEES</title>
...
<div style="border-style:solid; border-width:1px; border-color: #6F6968; background-color: #5A7ACF;  padding: 2px; margin-left: 2px; margin-right: 2px; margin-top: 2px; margin-bottom: 0px;  text-align: left;">
   ...
   <div style="border-style:solid; border-width:1px; border-color: #6F6968; background-color: #FFFFFF;  padding: 20px; margin: 2px; text-align:justify">
	En enregistrant votre &eacute;tablissement parmi les &eacute;tablissements utilisateurs de Gees:<br /><br />
	<ul>
	  <li>vous encouragez l'&eacute;quipe des d&eacute;veloppeurs. (bénévoles pour la plupart, il faut le rappeler)</li>
	  <li>vous donnez du poids et de la consistance &agrave; la communaut&eacute; des utilisateurs de Gees, ce qui peut avoir de l'importance au moment de certains choix politiques ou n&eacute;gociations techniques (demande d'ouverture des exports de Sconet par exemple).</li>
	  <li>vous pouvez &eacute;ventuellement devenir vous-m&ecirc;me un interlocuteur pour des coll&egrave;gues recherchant des informations sur Gees.</li>
	</ul><br />
...
<?php if($etape==='1') { ?>
<div style="border-style:solid; border-width:1px; border-color: #6F6968; background-color: #5A7ACF;  padding: 2px; margin-left: 2px; margin-right: 2px; margin-top: 2px; margin-bottom: 0px;  text-align: left;">
   <div style="border-style:solid; border-width:0px; border-color: #6F6968; background-color: #5A7ACF;  padding: 2px; margin: 2px; font-family: Helvetica,Arial,sans-serif; font-weight: bold; color: #FFFFFF;">Enregistrement de Gees</div>
   ...
   <div style="border-style:solid; border-width:1px; border-color: #6F6968; background-color: #FFFFFF;  padding: 0px; margin: 0px;">
	<form action="fenetre.php" method="post" enctype="text/plain">
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="0">
	        <tr style="background-color: #DFE8FF"><td style="width: 300px;"><label for="pref211">Adresse mél du correspondant Gees</label></td><td style="width: 150px;"><input maxlength="200" size="15" name="pref211" id="pref211" class="input" onfocus="javascript:this.select()" value="" /></td></tr>
	        <tr style="background-color: #EFF3FF"><td style="width: 300px;"><label for="pref1">Cette version de Gees est installée à des fins</label></td><td style="width: 150px;">
...
<?php /*		<tr style="background-color: #EFF3FF;"><td><label for="pref5">Mon établissement (nom patronymique et ville seulement) peut figurer dans la liste des "établissements utilisateurs de Gees" sur le site public de Gees.</label></td><td style="text-align: center;"><input checked="checked" name="pref5" id="pref5" type="radio" /></td></tr>
		<tr style="background-color: #DFE8FF;"><td><label for="pref6">Seule l'équipe des développeurs peut avoir connaissance de l'utilisation de Gees par mon établissement.</label></td><td style="text-align: center;"><input name="pref5" id="pref6" type="radio" /></td></tr>
...
*/ ?>
		<tr style="background-color: #EFF3FF;"><td colspan="2"><input checked="checked" name="pref5" id="pref5" type="radio" /><label for="pref5">Mon établissement (nom patronymique et ville seulement) peut figurer dans la liste des "établissements utilisateurs de Gees" sur le site public de Gees.</label></td></tr>
		<tr style="background-color: #DFE8FF;"><td colspan="2"><input name="pref5" id="pref6" type="radio" /><label for="pref6">Seule l'équipe des développeurs peut avoir connaissance de l'utilisation de Gees par mon établissement.</label></td></tr>
