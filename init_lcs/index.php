...
?>
<ul>
<li>Au cours de la procédure, le cas échéant, certaines données de l'année passée seront définitivement effacées de la base GEES (<em>élèves, notes, appréciations,...</em>). Seules seront conservées les données suivantes :<br /><br />
