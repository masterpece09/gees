...
function add_eleve($_login, $_nom, $_prenom, $_civilite, $_naissance, $_elenoet = 0) {
    // Fonction d'ajout d'un élève dans la base Gees
...
if (isset($_POST['step'])) {
    ...
    if ($_POST['step'] == "1") {
        ...
        if ($_POST['record'] == "yes") {
			...
			echo "<br />\n";
			echo "<p><em>On supprime les anciens comptes élèves dans Gees...</em> ";
    ...
    echo "<p>Etes-vous sûr de vouloir importer tous les élèves depuis l'annuaire du serveur LCS vers Gees ?</p>";
    echo "<br/>";
