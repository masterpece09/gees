...
if (isset($_POST['is_posted'])) {
    ...
    if ($_POST['record'] == "yes") {
        ...
        echo "<p>Vous pouvez vérifier l'importation en allant sur la page de <a href='../matieres/index.php'>gestion des matières</a>.</p>";
            ...
            echo "<p>Les matières en vert indiquent des matières déjà existantes dans la base GEES.<br />Les matières en rouge indiquent des matières nouvelles et qui vont être ajoutées à la base GEES.<br /></p>";
    ...
    echo "<p>Etes-vous sûr de vouloir importer toutes les matières depuis l'annuaire du serveur LCS vers Gees ?</p>";
    echo "<br/>";
