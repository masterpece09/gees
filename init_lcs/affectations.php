...
//        echo "<p>Vous pouvez vérifier l'importation en allant sur la page de <a href='../matieres/index.php'>gestion des matières</a>.</p>";
    ...
    echo "<p>Pour chaque classe et chaque matière actuellement présentes dans la base GEES, le script recherche les professeurs membres des groupes du type \"Cours_classe_matiere..\" et les affecte au couple (classe/matière).</p>";
