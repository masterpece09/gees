...
if (!isset($is_posted)) {
	echo "<p>Vous allez effectuer la première étape&nbsp;: elle consiste à importer le fichier <b>ELEVES.CSV</b> (<em>généré à partir des exports XML de Sconet</em>) contenant toutes les données dans une table temporaire de la base de données de <b>GEES</b>.";
