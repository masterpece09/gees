...
if (!isset($step1)) {
	...
	if ($flag != 0){
		...
		echo "Des professeurs principaux sont actuellement définis dans la base GEES<br /></p>\n";
...
*/
			...
			if ($nb_reg_no != 0) {
				...
				if($nb_reg_ok>0){
					echo "<p>L'importation des professeurs principaux dans la base GEES a été effectuée avec succès !</p>\n";
				}
				else{
					echo "<p>Aucun professeur principal n'a été inscrit dans la base GEES !</p>\n";
				}
				...
				echo "<p>Vous pouvez procéder à l'étape suivante de nettoyage des tables GEES.</p>\n";
