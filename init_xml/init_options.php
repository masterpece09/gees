...
//echo "<p>L'importation des options suivies par les élèves dans la base GEES a été effectuée avec succès !<br />Vous pouvez procéder à l'étape suivante de nettoyage des tables GEES.</p>\n";
//echo "<center><p><a href='clean_tables.php'>Suppression des données inutiles</a></p></center>\n";
echo "<p>L'importation des options suivies par les élèves dans la base GEES a été effectuée avec succès !<br />Vous pouvez procéder à l'étape suivante d'import des professeurs principaux.</p>\n";
