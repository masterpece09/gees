...
?>
	...
	document.location.replace("../../../login.php")
			...
			if(!isset($_POST['is_posted'])) {
				//echo "<p>Cette page permet de remplir des tableaux PHP avec les informations professeurs, matières,... mais pas encore les liaisons profs/matières/classes.<br />Elle génère des fichiers CSV permettant un import des comptes profs pour GEES.</p>\n";
				echo "<p>Cette page permet de remplir des tables temporaires avec les informations professeurs, matières,...<br />Elle génère des fichiers CSV permettant un import des comptes profs pour GEES.</p>\n";
...
';
				...
				if(!is_uploaded_file($xml_file['tmp_name'])) {
					...
					echo "<p>Aller à la <a href='#gepi'>section GEES</a><br />Si vous patientez, des liens directs seront proposés (<i>dans un cadre jaune</i>) pour télécharger les fichiers.<br />Si la page finit son chargement sans générer de cadre jaune, il se peut que la configuration de PHP donne un temps de traitement trop court";
					...
					echo "<p style='color:red;'><b>A faire</b>: un fichier profs pour GEES...</p>\n";
					...
					echo "<a name='f_wind_gepi'></a><h2>Génération du CSV (F_WIND.CSV) des profs pour GEES</h2>\n";
					echo "<blockquote>\n";
					$cpt=0;
...
<p>Imprimez cette page, puis supprimez-la en procédant au nettoyage comme indiqué à la page précédente.</p>
					...
					echo "<a name='f_men_gepi'></a><h2>Génération d'un CSV du F_MEN pour GEES</h2>\n";
					echo "<blockquote>\n";
					...
					echo "<a name='f_gpd_gepi'></a><h2>Génération d'un CSV du F_GPD pour GEES</h2>\n";
					echo "<blockquote>\n";
					...
					echo "<a name='f_tmt_gepi'></a><h2>Génération d'un CSV du F_TMT pour GEES</h2>\n";
					echo "<blockquote>\n";
					...
					echo "<a name='f_div_gepi'></a><h2>Génération d'un CSV du F_DIV pour GEES</h2>\n";
					echo "<blockquote>\n";
					...
					echo "<h4 style='margin:0; padding:0; text-align:center;'>GEES</h4>\n";
