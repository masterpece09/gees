...
*/
	...
	*/
	...
	// GeesAccesOptionsReleveParent
	// GeesAccesOptionsReleveEleve
	//+++++++++++++++++++++++++++++++++++
	...
	document.getElementById('td_ele').innerHTML='".$current_eleve_login[$i]."';
				...
				if(mysqli_num_rows($test_appartenance_classe_periode)>0) {
					...
					if($_SESSION['statut']=='professeur') {
						...
						elseif (getSettingValue("GeesAccesReleveProf") == "yes") {
						...
						elseif (getSettingValue("GeesAccesReleveProfTousEleves") == "yes") {
					...
					elseif (($_SESSION['statut'] == 'scolarite') AND (getSettingValue("GeesAccesReleveScol") == "yes")) {
					...
					elseif (($_SESSION['statut'] == 'eleve') AND
							(getSettingValue("GeesAccesReleveEleve") == "yes") AND
					...
					elseif (($_SESSION['statut'] == 'responsable') AND
							(getSettingValue("GeesAccesReleveParent") == "yes")) {
