...
if ((($_SESSION['statut']=='professeur') AND (getSettingValue("GeesProfImprRelSettings")!='yes')) OR 
(($_SESSION['statut']=='scolarite') AND (getSettingValue("GeesScolImprRelSettings")!='yes')) OR 
(($_SESSION['statut']=='cpe') AND (getSettingValue("GeesCpeImprRelSettings")!='yes')) OR 
// Les comptes administrateurs n'ont pas accès aux relevés de notes normalement...
(($_SESSION['statut']=='administrateur') AND (getSettingValue("GeesAdminImprBulSettings")!='yes')))
{
