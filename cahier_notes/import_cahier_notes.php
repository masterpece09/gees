...
Le premier champ des lignes élèves doit contenir la chaine GEES_LOGIN_ELEVE.</p>

<pre>
GEES_INFOS;GEES_LOGIN_ELEVE;NOM;PRENOM;CLASSE;MOYENNE;GEES_COL_1ER_DEVOIR
GEES_DEV_NOM_COURT;;;;;Nom court du devoir:;Devoir1;Devoir2;Oral1
GEES_DEV_COEF;;;;;Coefficient:;3,0;3,0;1,0
GEES_DEV_NOTE_SUR;;;;;Notation sur:;20;20;20
GEES_DEV_DATE;;;;;Date:;15/09/2009;12/10/2009;15/11/2009
GEES_LOGIN_ELEVE;ABBA_B;ABBA;Bart;3 A2;;15,5;15,0;12,0
GEES_LOGIN_ELEVE;GOLADE_L;GOLADE;Larry;3 A2;;11,0;14,0;13,0
GEES_LOGIN_ELEVE;ZETOFRE_M_L;ZETOFREY;Melanie;3 A2;;10,5;14,5;19,0
...
</pre>
	...
	if(!isset($_POST['valide_insertion_devoirs'])) {
		...
		if (trim($csv_file['name'])=='') {
			...
			if(!$fp){
				...
				$tabchamps=array("GEES_INFOS","GEES_LOGIN_ELEVE","GEES_COL_1ER_DEVOIR");
