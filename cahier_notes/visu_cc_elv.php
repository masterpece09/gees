...
if (getSettingValue("active_carnets_notes")!='y') {
  ...
  */
if (getSettingValue("GeesAccesEvalCumulEleve")!='yes') {
...
?>
	...
	<script type="text/javascript">
		//<![CDATA[
			...
			if (gepi_start_session.get('GEES_start_session')) {
				gepi_start_session.clear('GEES_start_session');
			}
			gepi_start_session.set('GEES_start_session', debut_alert.getTime())
			/* =================================================
			 =
			 =
			 =
			...
			function show_message_deconnexion() {
				...
				<?php
					...
					/*
					// Avec le dispositif maintien_de_la_session() de lib/share.inc.php pointant vers lib/echo.php, on devrait pouvoir ne tenir compte que de la variable Gees: sessionMaxLength
				...
				if (gepi_start_session.get('GEES_start_session')) {
					debut_alert.setTime(parseInt(gepi_start_session.get('GEES_start_session'),10));
				}
				digital=new Date()
