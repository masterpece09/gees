...
if (!isset($id_classe) and (!isset($id_groupe)) and $_SESSION['statut'] != "responsable" and $_SESSION['statut'] != "eleve") {
	...
	if ((($_SESSION['statut'] == 'scolarite') AND (getSettingValue("GeesAccesReleveScol") == "yes"))
    	OR (($_SESSION['statut'] == 'cpe') AND ((getSettingValue("GeesAccesReleveCpe") == "yes") OR (getSettingValue("GeesAccesReleveCpeTousEleves") == "yes")))
...
// rajout christian
			if(
				((($_SESSION['statut'] == 'scolarite') AND (getSettingValue("GeesAccesReleveScol") == "yes"))
					OR (($_SESSION['statut'] == 'cpe') AND ((getSettingValue("GeesAccesReleveCpe") == "yes") OR (getSettingValue("GeesAccesReleveCpeTousEleves") == "yes"))))
				AND $format == "pdf")
			{
...
// fin rajout christian
			...
			if ((getSettingValue("GeesAccesReleveProfP") == "yes") AND (getSettingValue("GeesAccesReleveProf") !="yes") AND (getSettingValue("GeesAccesReleveProfTousEleves") !="yes") AND (getSettingValue("GeesAccesReleveProfToutesClasses") !="yes")) {
				...
				$nombre_classe = mysqli_num_rows($call_prof_classe);
				...
				} else if (getSettingValue("GeesAccesReleveProf") == "yes" OR (getSettingValue("GeesAccesReleveProfToutesClasses") =="yes") OR (getSettingValue("GeesAccesReleveProfTousEleves") =="yes")) {
					if (getSettingValue("GeesAccesReleveProfTousEleves") == "yes" AND (getSettingValue("GeesAccesReleveProfToutesClasses") != "yes")) {
					...
					} elseif (getSettingValue("GeesAccesReleveProfToutesClasses") =="yes") {
		...
		if (($_SESSION['statut']=='professeur') AND (getSettingValue("GeesAccesReleveProf")!="yes") AND (getSettingValue("GeesAccesReleveProfTousEleves")!="yes") AND (getSettingValue("GeesAccesReleveProfToutesClasses")!="yes") AND (getSettingValue("GeesAccesReleveProfP") != "yes")) {
			tentative_intrusion(2, "Tentative d'un professeur d'accéder aux relevés de notes sans y être autorisé.");
			...
			(($_SESSION['statut'] == "scolarite") AND (getSettingValue("GeesAccesReleveScol") != "yes"))
			OR (($_SESSION['statut'] == 'cpe') AND (getSettingValue("GeesAccesReleveCpe") != "yes") AND (getSettingValue("GeesAccesReleveCpeTousEleves") != "yes"))
			OR ($_SESSION['statut'] == 'responsable' AND getSettingValue("GeesAccesReleveParent") != "yes")
			OR ($_SESSION['statut'] == 'eleve' AND getSettingValue("GeesAccesReleveEleve") != "yes")) {
			...
			die();
    			...
    			(getSettingValue("GeesAccesReleveProf")!="yes") AND
    			(getSettingValue("GeesAccesReleveProfTousEleves")!="yes") AND
    			(getSettingValue("GeesAccesReleveProfToutesClasses")!="yes") AND
    			(getSettingValue("GeesAccesReleveProfP") == "yes")) {
	...
	/*
     			...
     			(getSettingValue("GeesAccesReleveProfToutesClasses") == "yes")
     			) {
	*/
		} else if (($_SESSION['statut'] == "professeur") AND
     			((getSettingValue("GeesAccesReleveProf") == "yes") OR
			...
			if (getSettingValue("GeesAccesReleveProfTousEleves") != "yes" AND getSettingValue("GeesAccesReleveProfToutesClasses") != "yes") {
				...
				if (getSettingValue("GeesAccesReleveProfToutesClasses") != "yes") {
...
//echo "<select size=\"1\" name=\"login_eleve\" onchange=\"active(".$indice.")\" onfocus=\"active(".$indice.")\">\n";
						...
						// Il faudrait filtrer la liste des élèves dans le cas cpe avec GeesAccesReleveCpe="yes", mais pas "GeesAccesReleveCpeTousEleves"="yes"
			 			if (!$current_group) {
	...
	*/
	...
	if(($_SESSION['statut']=='eleve')||($_SESSION['statut']=='responsable')) {
		...
		if (($_SESSION['statut']=='eleve') AND (getSettingValue("GeesAccesOptionsReleveEleve") == "yes")) {
		...
		if (($_SESSION['statut']=='responsable') AND (getSettingValue("GeesAccesOptionsReleveParent") == "yes")) {
			//echo "<p><br />\n";
...
echo "</form>\n";
	...
	if (($_SESSION['statut']=='professeur') AND (getSettingValue("GeesAccesReleveProf")!="yes") AND (getSettingValue("GeesAccesReleveProfTousEleves")!="yes") AND (getSettingValue("GeesAccesReleveProfToutesClasses")!="yes") AND (getSettingValue("GeesAccesReleveProfP") != "yes")) {
    	...
    	AND (getSettingValue("GeesAccesReleveProfP") == "yes")
    	AND (getSettingValue("GeesAccesReleveProf") != "yes")
    	AND (getSettingValue("GeesAccesReleveProfTousEleves") != "yes")
    	AND (getSettingValue("GeesAccesReleveProfToutesClasses") != "yes")
    	) {
		$test_classe = sql_query1("SELECT distinct c.id FROM classes c, j_eleves_professeurs s, j_eleves_classes cc
					WHERE (
					s.professeur='" . $_SESSION['login'] . "' AND
	...
	} else if (($_SESSION['statut'] == "professeur") AND ((getSettingValue("GeesAccesReleveProf") == "yes") OR (getSettingValue("GeesAccesReleveProfTousEleves") == "yes") OR (getSettingValue("GeesAccesReleveProfToutesClasses") == "yes"))) {
