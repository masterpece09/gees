...
//echo getSettingValue('GeesAccesColMoyReleveEleve');
if(($_SESSION['statut']=='eleve')&&(getSettingAOui('GeesAccesColMoyReleveEleve'))||
...
if(($_SESSION['statut']=='eleve')&&(getSettingAOui('GeesAccesMoyMinClasseMaxReleveEleve'))||
($_SESSION['statut']=='responsable')&&(getSettingAOui('GeesAccesMoyMinClasseMaxReleveParent'))) {
	$tab_rn_moy_min_max_classe[0]="y";
	$tab_rn_moy_classe[0]="n";
}
elseif(($_SESSION['statut']=='eleve')&&(getSettingAOui('GeesAccesMoyClasseReleveEleve'))||
($_SESSION['statut']=='responsable')&&(getSettingAOui('GeesAccesMoyClasseReleveParent'))) {
