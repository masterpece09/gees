...
// =============
	...
	<ul>
		...
		Les calculs de moyennes que vous pourrez faire dans un tableur peuvent donc différer des moyennes calculées dans Gees en tenant compte de l'arborescence des ".getSettingValue('gepi_denom_boite').".</p></li>
