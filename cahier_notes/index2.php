...
if ($_SESSION['statut'] == "professeur") {
	...
	if ( (getSettingValue("GeesAccesMoyennesProf") != "yes") AND
	(getSettingValue("GeesAccesMoyennesProfTousEleves") != "yes") AND
	(getSettingValue("GeesAccesMoyennesProfToutesClasses") != "yes")
	) {

		if((getSettingAOui('GeesAccesReleveProfP'))&&(is_pp($_SESSION['login']))) {
			if(isset($id_classe)) {
...
//}
	...
	echo "/><label for='forcer_hauteur_ligne_pdf'> Forcer la hauteur des lignes du tableau PDF à </label><input type='text' name='visu_toutes_notes_h_cell_pdf' size='2' value='".getPref($_SESSION["login"], "visu_toutes_notes_h_cell_pdf", 10)."' onkeydown=\"clavier_2(this.id,event,1,20);\" autocomplete=\"off\" /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<em>sinon Gees calcule au mieux la hauteur de ligne</em>)</p>\n";
...
display_div_coloriser();
	...
	elseif($_SESSION['statut'] == 'professeur' and getSettingValue("GeesAccesMoyennesProfToutesClasses") != "yes"){
...
if ($_SESSION['statut'] == "professeur"
	AND getSettingValue("GeesAccesMoyennesProfToutesClasses") != "yes"
	AND getSettingValue("GeesAccesMoyennesProfToutesTousEleves") != "yes") {
