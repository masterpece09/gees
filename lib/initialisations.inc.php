...
/**
 * Niveau de la page dans l'arborescence de GEES
 *
...
/**
 * Chemin relatif vers la racine de GEES
 *
...
if($is_lcs_plugin=='yes') {
   ...
   */
  require_once ('/usr/share/lcs/Plugins/Gees/secure/config_lcs.inc.php');
  /**
...
/**
 * Pour permettre de caser Gees dans un iframe avec M$IE sur certains ENT
 */
...
// Initialisation de la session Gees :
