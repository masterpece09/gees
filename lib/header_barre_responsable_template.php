 ...
 *******************************************************************/
	...
	if ($_SESSION['statut'] == "responsable") {
		...
		// Cahiers de textes
		if((getSettingAOui("active_cahiers_texte"))&&(getSettingAOui("GeesAccesCahierTexteParent"))) {
		...
		// Carnet de notes
		if((getSettingAOui("active_carnets_notes"))&&(getSettingAOui("GeesAccesReleveParent"))) {
		...
		if(getSettingAOui("active_bulletins")) {
			if((getSettingAOui("GeesAccesBulletinSimpleParent"))&&(getSettingAOui("GeesAccesGraphParent"))) {
			...
			elseif(getSettingAOui("GeesAccesBulletinSimpleParent")) {
			...
			elseif(getSettingAOui("GeesAccesGraphParent")) {
		...
		// Equipe pédagogique
		if(getSettingAOui("GeesAccesEquipePedaParent")) {
