...
class LDAPServer {
	...
	# Le répertoire de Gees est considéré comme la racine (mais il est possible
	...
	# LDAP à des champs de la table utilisateurs de Gees.
	# Seuls ces champs sont utilisés lors de la création à la
	# volée de comptes utilisateurs depuis le LDAP, ou bien lors
	# de la synchronisation dans le sens Gees -> LDAP (accès en
	# écriture.
	var $champ_login = "uid";
	var $champ_prenom = "";
	var $champ_nom = "sn";
	var $champ_nom_complet = "cn";
	var $champ_email = "mail";
	var $champ_statut = "";
	var $champ_civilite = "";
	var $champ_rne = "";

	var $code_civilite_madame = "Mme";
	...
	var $chaine_dn_statut_responsable = "";
	...
	# Renvoie les informations de l'utilisateur, au format correct Gees
	# dans un tableau
