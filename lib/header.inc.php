 ...
 * 
 * $titre_page
 * $racineGees → chemin relatif vers la racine de GEES
 * $tbs_last_connection
 */
$tbs_last_connection = isset ($tbs_last_connection) ? $tbs_last_connection : '';
//$titre_page = isset ($titre_page) ? $titre_page : 'GEES';
...
$tbs_bouton_taille = isset ($tbs_bouton_taille) ? $tbs_bouton_taille : $racineGees ;

if(isset($_SESSION['statut'])) {
	switch ($_SESSION['statut']) {
		case 'professeur':
			include_once $racineGees.'/edt_organisation/fonctions_calendrier.php';
			break;
		default :
			break;
	}
...
<head>
<!-- on inclut l'entête -->
	<?php include($racineGees.'/templates/origine/header_template.php'); ?>


	<link rel="stylesheet" type="text/css" href="<?php echo $racineGees;?>/templates/origine/css/accueil.css" media="screen" />
	<link rel="stylesheet" type="text/css" href="<?php echo $racineGees;?>/templates/origine/css/bandeau.css" media="screen" />
...
<!-- on inclut le bandeau -->
	<?php
		if(isset($titre_page)) {
			...
			include($racineGees.'/templates/origine/bandeau_template.php');
		}
	?>
