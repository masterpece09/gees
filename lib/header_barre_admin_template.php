 ...
 *******************************************************************/
	...
	if ($_SESSION['statut'] == "administrateur") {
		...
		$menus .= '     <li><a href="'.$gepiPath.'/gestion/droits_acces.php" '.insert_confirm_abandon().' title="Cette page permet de définir à quelles informations, à quels modules de Gees,... les différents statuts (administrateur, scolarité, cpe, professeur, secours, élève, responsable, autre) ont droit d\'accéder.">Droits d\'accès</a></li>'."\n";
		...
		if(!getSettingAOui('gepi_en_production')) {
			...
			$menus .= '    <li><span title="Effacer la base : Choix désactivé sur un Gees en production.
                           Votre Gees est paramétré comme un Gees en production :
                           On ne vide normalement pas la base sur un Gees en production.
                           Si votre Gees est un Gees de test, vous pouvez modifier ce
                           paramétrage dans
		...
		$menus .= '        <li class="plus"><a href="'.$gepiPath.'/utilisateurs/index.php" '.insert_confirm_abandon().' title="Les comptes d\'utilisateurs permettent de se connecter dans Gees">Utilisateurs</a>'."\n";
...
Vous pouvez notamment faire apparaître un tableau des dates de conseils de classe.">Date événements</a></li>'."\n";
		...
		if(!getSettingAOui('gepi_en_production')) {
			...
			$menus .= '    <li><span title="Données de test : Choix désactivé sur un Gees en production.
                               Les données de test ajoutent des enregistrements dans la
                               base pour pouvoir tester Gees sans remplir soi-même la base.
                           
                               Votre Gees est paramétré comme un Gees en production :
                               Normalement, on n ajoute pas dans la base des données
                               de test sur un Gees en production.
                               Si votre Gees est un Gees de test, vous pouvez modifier ce
                               paramétrage dans
