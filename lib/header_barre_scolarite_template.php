 ...
 *******************************************************************/
	...
	if ($_SESSION['statut'] == "scolarite") {
		...
		if (getSettingValue("active_cahiers_texte") == 'y') {
			if((getSettingAOui('GeesAccesCdtScol'))||(getSettingAOui('GeesAccesCdtScolRestreint'))) {
			...
			elseif(getSettingValue('GeesAccesCdtVisa')=='yes') {
		...
		if(getSettingValue("active_carnets_notes") == 'y'){
			...
			if (getSettingValue("active_bulletins") == "y") {
				...
				if(getSettingValue('GeesRubConseilScol')=='yes') {
...
Vous pouvez notamment faire apparaître un tableau des dates de conseils de classe.">Dates événements</a></li>'."\n";
				...
				$menus .= '            <ul class="niveau3">'."\n";
				if(getSettingValue('GeesScolImprBulSettings')=='yes') {
