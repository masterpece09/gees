...
#########################################################################
#                                                                       #
#               Paramètres de configuration de GEES (partie I)          #
#                                                                       #
#########################################################################
...
// Gees est configuré de manière à bloquer temporairement le compte d'un utilisateur
...
// Liste des adresses IP qui ne peuvent pas se connecter à GEES
...
##################################################################################
#                                                                                #
#               Paramètres de configuration de GEES (partie II)                  #
...
$gepiVersion = "1.6.7";
$gepiSvnRev = "";
$gepiGitCommit="22aa340";
$gepiGitBranch = "";

// Forcer l'utilisation du module de référencement de GEES
//
// Ce paramètre sert à forcer l'utilisation du module d'enregistrement
// de GEES, qui n'est pas encore considéré comme stable
// mais reste présent dans l'archive
// Note : ce module devrait être stabilisé pour la prochaine version de Gees
...
$message_cnil_bons_usages="* En conformité avec la CNIL, les utilisateurs s'engagent à ne faire figurer dans Gees que des commentaires respectueux des élèves, responsables et personnels.<br />";
