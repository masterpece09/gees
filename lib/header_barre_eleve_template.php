 ...
 *******************************************************************/
	...
	if ($_SESSION['statut'] == "eleve") {
		...
		// Cahiers de textes
		if((getSettingAOui("active_cahiers_texte"))&&(getSettingAOui("GeesAccesCahierTexteEleve"))) {
		...
		// Carnet de notes
		if((getSettingAOui("active_carnets_notes"))&&(getSettingAOui("GeesAccesReleveEleve"))) {
		...
		if(getSettingAOui("active_bulletins")) {
			if((getSettingAOui("GeesAccesBulletinSimpleEleve"))&&(getSettingAOui("GeesAccesGraphEleve"))) {
			...
			elseif(getSettingAOui("GeesAccesBulletinSimpleEleve")) {
			...
			elseif(getSettingAOui("GeesAccesGraphEleve")) {
		...
		// Equipe pédagogique
		if(getSettingAOui("GeesAccesEquipePedaEleve")) {
