...
// Pour les scripts situés à la racine de GEES
...
// Pour les scripts situés dans un sous-répertoire à l'intérieur d'une sous-répertoire de GEES
...
// Pour les scripts situés dans un sous-sous-répertoire à l'intérieur d'une sous-répertoire de GEES
...
// Pour les scripts situés dans un sous-répertoire GEES
} else {
   // Database configuration file
   require_once("../secure/connect.inc.php");
	//propel objects
