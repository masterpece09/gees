...
$is_pp_header_barre_prof_template=is_pp($_SESSION['login']);
	...
	if(getSettingValue("active_carnets_notes") == 'y'){
		...
		if((getSettingValue("GeesAccesReleveProf") == "yes") OR
		...
		if((getSettingValue("GeesAccesMoyennesProf") == "yes") OR
		...
		if (getSettingValue("active_bulletins") == "y") {
			...
			$cpt_sous_menu=0;
				...
				if((getSettingValue("GeesRubConseilProf") == "yes")&&($is_pp_header_barre_prof_template)) {
				...
				if((getSettingAOui('GeesProfImprBul'))&&($is_pp_header_barre_prof_template)) {
