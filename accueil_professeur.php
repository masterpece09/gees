...
$titre_page = "Accueil GEES - Professeurs";
...
if((getSettingValue('active_cahiers_texte')=='y')&&(getSettingValue('GeesCahierTexteVersion')=='2')) {
...
$condition_releve_note = (
	...
	(
		...
		((getSettingValue("GeesAccesReleveProfP") == "yes") AND ($test_prof_suivi != "0"))
	)
);
...
if ($condition_releve_note ||  (getSettingValue("GeesAccesBulletinSimplePP")=="yes") || ($active_module_trombinoscopes=='y') || ($active_module_trombino_pers=='y') || ($nb_total != 0)) {
	echo "<div class='bloc_page_acceuil_professeur'>";
	echo '<table class="table_acceuil">';
	echo '<tbody>';
...
/**********************************************
	Preparer le conseil
**********************************************/
if (($test_prof_suivi != "0") and (getSettingValue("GeesRubConseilProf")=='yes')) {
	echo "<div class='bloc_page_acceuil_professeur'>";
	echo '<table class="table_acceuil">';
	echo '<tbody>';
