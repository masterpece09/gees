...
if(getSettingAOui('gepi_en_production')) {
	...
	echo "<p style='color:red'>Cette page ne doit pas être utilisée sur un Gees en production.<br />Vous copieriez des devoirs d'une classe vers une autre, avec la possibilité d'insérer des notes aléatoires.</p>\n";
...
Cette page a été réalisée pour insérer rapidement des données afin de présenter Gees à des parents d'élèves lors d'une journée portes ouvertes.</p>\n";
require("../lib/footer.inc.php");
?>
