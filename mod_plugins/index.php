...
/**
 * Ce fichier est destiné à organiser les plugins de Gees.
...
<h3 class="Gees">Liste des plugins install&eacute;s</h3>
<p>Pour plus d'informations concernant les plugins de Gees, voyez
...
?>
<br/><span style="color: red;font-weight:bold;">Attention</span> : les plugins dont la version gepi est indiquée en rouge ne sont peut être pas adaptés à la version courante de Gees (<?php echo $gepiVersion; ?>).
<?php
}
?>
