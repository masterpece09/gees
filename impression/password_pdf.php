...
//recherche du dossier racine de GEES pour obtenir l'adresse de l'application à saisir dans le navigateur
...
if (($donnees_personne_csv)) {
	...
	for ($i=0; $i<$nb_enr_tableau ; $i++) {
		...
		$texte = "\nA l'attention de ".$prenom." ".$nom." , classe de ".$classe.
				...
				// "\nEmail : ".$email.
				 "\nAdresse du site Gees à saisir dans votre navigateur Internet : ".$adresse_site_gepi."\n".$texte_presentation."\n\n";
