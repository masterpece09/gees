...
/**
 * Classe qui implémente un serveur pour permettre à un ENT de se connecter à GEES
...
class serveur_ent {
   ...
   *
   * @example Si on est en multisite, il faut un cookie["RNE"] qui donne le bon RNE pour que GEES se connecte sur la bonne base
   */
  public function __construct(){
    ...
    // On vérifie si les logins des enfants envoyés existent bien dans GEES
  ...
  /**
   * Renvoie la liste des classes de GEES avec la liste des professeurs pour chaque classe
   * classe, liste prof dans cette classe
   *
   * @return array Tableau des classes de Gees : nom, nom_complet, '', '', '', '', liste des logins des professeurs de la classe
   */
