...
/***** Tri des menus *****/
  ...
  $this->creeNouveauItem("/absences/index.php",
	...
	if ((($this->test_prof_suivi != "0") and (getSettingValue("GeesRubConseilProf")=='yes'))
			or (($this->statutUtilisateur!='professeur') and (getSettingValue("GeesRubConseilScol")=='yes') )
...
// Et récupérer le paquet commentaires_types sur... ADRESSE A DEFINIR:
  ...
  private function cahierTexteCPE(){
	...
	getSettingValue("active_cahiers_texte")=='y' AND (
		($this->statutUtilisateur == "cpe" AND getSettingValue("GeesAccesCdtCpe") == 'yes')
		OR ($this->statutUtilisateur == "scolarite" AND getSettingValue("GeesAccesCdtScol") == 'yes')
	));
