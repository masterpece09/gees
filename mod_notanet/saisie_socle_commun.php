...
echo "<li>Voir <a href='https://www.sylogix.org/projects/gepi/wiki/Gees_socle_commun_notanet' target='_blank'>https://www.sylogix.org/projects/gepi/wiki/Gees_socle_commun_notanet</a></li>
<li>Dans l'interface Notanet (<em>hors de Gees</em>), il semble qu'il faille fournir l'export CSV des notes de Gees et aussi l'export XML de LPC.<br />
