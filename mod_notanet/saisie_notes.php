...
if((!isset($id_classe))||(!isset($id_groupe))) {
	...
	<tr>
		...
		//echo "$sql<br />";
		$res_matiere_notanet=mysqli_query($GLOBALS["mysqli"], $sql);
		while($lig_mn=mysqli_fetch_object($res_matiere_notanet)) {
...
if((isset($mode))&&($mode=='import_csv')) {
	...
	<fieldset class='fieldset_opacite50'>
		...
		<p style='text-indent: -2em; margin-left: 2em;'><input type='radio' name='type_csv' id='type_csv_2' value='2' /><label for='type_csv_2'> Fichier au format <strong>Identifiant GEES;Moyenne DNB</strong><br />
		(<em>ATTENTION&nbsp;: Le PackEPS suppose que l'identifiant est au format &lt;NOM&gt;_&lt;Initiale_du_Prenom&gt;;<br />ce n'est pas nécessairement le cas sur votre GEES</em>)</label></p>
