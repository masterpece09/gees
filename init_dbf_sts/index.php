...
<ul>
<li>
	<p>Au cours de la procédure, le cas échéant, certaines données de l'année passée seront définitivement effacées de la base GEES (élèves, notes, appréciations, ...).<br />
...
<li>
	...
	<ul>
		...
		<ul>
			<!--li>le NUMEN (INDNNI) utilisé comme mot de passe par défaut par GEES n'est pas récupéré.<br />
