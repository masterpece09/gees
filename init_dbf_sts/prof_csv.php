...
if (!isset($step1)) {
    ...
    if ($flag != 0){
        ...
        echo "<li>Les professeurs de l'année passée présents dans la base GEES et non présents dans la base GEP de cette année ne sont pas effacés de la base GEES mais simplement déclarés \"inactifs\".</li>";
        echo "</ul>";
...
*/
        ...
        echo "<p>Dans le tableau ci-dessous, les identifiants en rouge correspondent à des professeurs nouveaux dans la base GEES. les identifiants en vert correspondent à des professeurs détectés dans les fichiers GEP mais déjà présents dans la base GEES.<br /><br />Il est possible que certains professeurs ci-dessous, bien que figurant dans le fichier GEP, ne soient plus en exercice dans votre établissement cette année. C'est pourquoi il vous sera proposé en fin de procédure d'initialsation, un nettoyage de la base afin de supprimer ces données inutiles.</p>";
