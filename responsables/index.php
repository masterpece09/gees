...
Ces personnes devraient être supprimées dans Gees.
...
if($_SESSION['statut']=="scolarite") {
	...
	if((getSettingValue("import_maj_xml_sconet")==1)&&(getSettingAOui('GeesAccesMajSconetScol'))) {
		echo " | <a href=\"maj_import.php\">Mettre à jour depuis Sconet</a>\n";
	}
					...
					while($lig2=mysqli_fetch_object($res2)){
						...
						$res3=mysqli_query($GLOBALS["mysqli"], $sql);
							...
							if(mysqli_num_rows($res3)>1){
								echo " rowspan='".mysqli_num_rows($res3)."'";
							}
							echo ">\n";
