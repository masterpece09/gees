...
<?php
	...
	elseif(getSettingValue('mode_email_resp')=='sconet') {
		echo "Cela signifie que c'est ce qui est saisi <span class='bold'>dans Sconet</span> ou <span class='bold'>dans Gees dans Gestion des bases/Gestion des responsables</span> prime sur ce qui est saisi par le responsable dans <span class='bold'>Gérer mon compte</span>.";
	}
	echo "</p>\n";
