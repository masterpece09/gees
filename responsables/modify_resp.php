...
echo "<td valign='top'>\n";
	...
	if(isset($pers_id)){
		...
		if(mysqli_num_rows($test_compte)>0) {
			...
			if($_SESSION['statut']=="administrateur") {
				...
				elseif(getSettingAOui('GeesMemesDroitsRespNonLegaux')) {
	...
	if($mel!='') {
		$tmp_date=getdate();
		echo " <a href='mailto:".$mel."?subject=".getSettingValue('gepiPrefixeSujetMail')."GEES&amp;body=";
...
Cliquez pour donner l'accès.\" /></a>";
					...
					if($lig_ele->envoi_bulletin=='y') {
						...
						echo " onclick=\"return confirm_abandon (this, change, '$themessage')\"";
						echo "><img src='../images/icons/bulletin.png' width='16' height='16' title=\"Le responsable non légal $resp_prenom $resp_nom est destinataire des bulletins générés dans Gees.
...
Cliquez pour supprimer la génération de bulletins à destination de ce responsable.\" /></a>";
						...
						echo " onclick=\"return confirm_abandon (this, change, '$themessage')\"";
						echo "><img src='../images/icons/bulletin_barre.png' width='16' height='16' title=\"Le responsable non légal $resp_prenom $resp_nom n'est pas destinataire des bulletins générés dans Gees.
