				...
				if(!$fp){
					...
					*/
					...
					if ($nb_reg_no2 != 0) {
						...
						echo "<p>L'importation des adresses de responsables dans la base GEES a été effectuée avec succès (".$nb_record2." enregistrements au total).</p>\n";
					}
					*/
			...
			if(mb_strtoupper($csv_file['name']) == "PERSONNES.CSV") {
				...
				if(!$fp){
					...
					if ($nb_reg_no3 != 0) {
						...
						echo "<p>L'importation des personnes (responsables) dans la base GEES a été effectuée avec succès (".$nb_record3." enregistrements au total).</p>\n";
					}
					*/
				}
			} else if (trim($csv_file['name'])=='') {
			...
			if(document.getElementById('check_'+i)){
				if(mode=='coche'){
					...
					if ($nb_reg_no1 != 0) {
						...
						echo "<p>L'importation des relations eleves/responsables dans la base GEES a été effectuée avec succès (".$nb_record1." enregistrements au total).</p>\n";
					}
					*/
