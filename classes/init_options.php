    ...
    while($i < $nombre_lignes) {
        ...
        while ($j < $nb_options) {
            ...
            if ($matiere != '') {
                ...
                if ($suit_option == 'no') {
                    // on gère le cas ou on a choisit au moins deux fois la meme matiere GEES pour deux matières GEP différentes
...
if ($info == 'no') {
    ...
    echo "<p>Les données du tableau ci-dessous sont fournies par les fichiers GEP. Si vous désirez importer ces informations dans GEES, vous devez, pour chacune des colonnes, mettre en correspondance le nom de la matière dans GEES (menu déroulant) avec le nom de l'option tel qu'elle est définie dans le fichier GEP.</p>";
}
?>
<p>
<table border=1 cellspacing=2 cellpadding=5>
<tr><td><b>Nom GEES de la matière : </b></td>
<?php
$i="0";
while ($i < $nb_options) {
    $temp = "matiere".$i;
