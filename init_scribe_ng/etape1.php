...
if (isset($_POST['step'])) {
    ...
    */
    ...
    if ($_POST['step'] == "1") {
        ...
        #  ->delete();
        $del = mysqli_query($GLOBALS["mysqli"], "DELETE FROM utilisateurs WHERE statut = 'eleve'");
        ...
        for($nb=0; $nb<$nb_eleves; $nb++) {
            ...
            // L'ele_id est très important dans Gees pour le lien eleve/responsable, mais dans Scribe il ne peut pas
            ...
            if ($ele_id) {
              ...
              // On créé maintenant son compte d'accès à Gees
              // On test si l'uid est deja connu de GEES
    ...
    echo "<p>Etes-vous sûr de vouloir importer tous les élèves depuis l'annuaire vers Gees ?</p>";
    echo "<br/>";
