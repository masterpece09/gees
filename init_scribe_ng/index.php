...
<p>Vous allez effectuer l'initialisation de l'année scolaire qui vient de débuter, directement depuis l'annuaire LDAP de Scribe NG.<br />
Celui-ci doit donc avoir été préalablement alimenté.<br />
Cette procédure ne s'effectue qu'<span style='color:red'>une seule fois par an</span>.</p>
...
<ul>
<li>Au cours de la procédure, le cas échéant, certaines données de l'année passée seront définitivement effacées de la base GEES (élèves, notes, appréciations, ...) . Seules seront conservées les données suivantes :<br /><br />
...
<li>Une fois toute la procédure d'initialisation des données terminée, il vous sera possible d'effectuer toutes les modifications nécessaires au cas par cas par le biais des outils de gestion inclus dans <b>GEES</b>.</li>
</ul>
