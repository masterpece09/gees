...
if (($_SESSION['statut']=='eleve')||($_SESSION['statut']=='responsable')) {
	...
	// Cas vécu: Un professeur fait une démonstration à un élève qui dit "Gees, ça ne marche pas".
...
if (($_SESSION['statut']!='autre')&&(!checkAccess())) {
	...
	/*
	** Alerte automatique sécurité Gees **

	Une nouvelle tentative d'intrusion a été détectée par Gees. Les détails suivants ont été enregistrés dans la base de données :
	...
	La tentative d'intrusion a été effectuée par un utilisateur non connecté à Gees.
	...
	if($envoi_mail_actif=="y") {
		echo "
			<tr>
				<th>Mail</th>
				<td>
					<input type='checkbox' name='doubler_par_envoi_mail' id='doubler_par_envoi_mail' value='y' onchange=\"checkbox_change('doubler_par_envoi_mail')\" /><label for='doubler_par_envoi_mail' id='texte_doubler_par_envoi_mail' title=\"Envoyer un mail en plus du message d'alerte dans Gees...
... sous réserve que le ou les destinataires aient une adresse mail renseignée dans Gees.
