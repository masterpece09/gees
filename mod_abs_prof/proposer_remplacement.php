					...
					if($insert) {
						...
						if(($envoi_mail_actif=='y')&&($envoi_mail=="y")) {
							...
							if(check_mail($mail_dest)) {
								...
								$subject = "[GEES]: Proposition de remplacement n°$id_proposition";
...
Vous pouvez accepter ou rejeter cette proposition dans Gees.
...
function affiche_lien_mailto_prof($mail_prof, $info_prof) {
	$retour=" <a href='mailto:".$mail_prof."?subject=".getSettingValue('gepiPrefixeSujetMail')."GEES&amp;body=";
	$tmp_date=getdate();
