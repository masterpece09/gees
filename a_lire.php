...
echo "<p>Voici quelques liens vers des fichiers d'information à propos de Gees&nbsp;:</p>
<ul>
	<li><a href='a_lire.php?fichier=INSTALL.txt#affichage_fichier'>INSTALL.txt</a>&nbsp;: Les explications concernant l'installation de Gees<br />
	(<em>si vous êtes ici, l'installation est probablement déjà faite;</em>)</li>
	<li><a href='a_lire.php?fichier=MAJ.TXT#affichage_fichier'>MAJ.TXT</a>&nbsp;: Les explications concernant la mise à jour vers la présente version de Gees<br />
	(<em>c'est le fichier que la personne qui a mis à jour le Gees dans la présente version a assurément lu</em>)</li>
	<li><a href='a_lire.php?fichier=README.txt#affichage_fichier'>README.txt</a>&nbsp;: À lire... comme son nom l'indique.</li>
	<li><a href='a_lire.php?fichier=changelog.txt#affichage_fichier'>changelog.txt</a>&nbsp;: L'historique des modifications et ajouts au fil des versions de Gees.</li>
	<li><a href='a_lire.php?fichier=COPYING.txt#affichage_fichier'>COPYING.txt</a>&nbsp;: La licence GPL.</li>
</ul>

<p>Voici par ailleurs les adresses de quelques ressources concernant Gees&nbsp;:</p>
<ul>
	<li><a href='http://www.sylogix.org/projects/gepi/wiki'>La documentation officielle de Gees</a></li>
	<li><a href='http://lists.sylogix.net/mailman/listinfo/gepi-users'>S'inscrire à la liste de diffusion Gees</a></li>
	<li><a href='http://www.mail-archive.com/gepi-users@lists.sylogix.net/'>Les archives de la liste de diffusion Gees</a><br />
