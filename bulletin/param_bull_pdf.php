		...
		<tr>
			...
			Taille du texte du <?php
				...
				if($gepi_prof_suivi=='') {
					...
					if($_SESSION['statut']!='administrateur') {
						$info_pp.="Signalez-le à l'administrateur du Gees pour qu'il corrige.</p>\n";
					}
					$info_pp.="</p>";
				}
