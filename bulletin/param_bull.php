...
if ((($_SESSION['statut']=='professeur') AND ((getSettingValue("GeesProfImprBul")!='yes') OR ((getSettingValue("GeesProfImprBul")=='yes') AND (getSettingValue("GeesProfImprBulSettings")!='yes')))) OR (($_SESSION['statut']=='scolarite') AND (getSettingValue("GeesScolImprBulSettings")!='yes')) OR (($_SESSION['statut']=='administrateur') AND (getSettingValue("GeesAdminImprBulSettings")!='yes')))
{
...
<table cellpadding="8" cellspacing="0" width="100%" border="0" summary='Mise en page'>
    ...
    <tr <?php if ($nb_ligne % 2) echo "bgcolor=".$bgcolor;$nb_ligne++; ?>>
        <td style="font-variant: small-caps;">
        <label for='bull_espace_avis' style='cursor: pointer;'>Espace (nombre de lignes vides) pour une saisie à la main de l'avis du Conseil de classe, si celui-ci n'a pas été saisi dans GEES :</label>
        </td>
