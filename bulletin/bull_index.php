...
if(!isset($tab_id_classe)) {
	...
	(($_SESSION['statut']=='professeur')&&(getSettingValue('GeesProfImprBulSettings')=='yes'))||
	(($_SESSION['statut']=='administrateur')&&(getSettingValue('GeesAdminImprBulSettings')=='yes'))||
	(($_SESSION['statut']=='cpe')&&(getSettingValue('GeesCpeImprBulSettings')=='yes'))) {
	...
	if (($_SESSION['statut'] == 'cpe') and getSettingValue("GeesCpeImprBul")!='yes') {
		echo "<p>Droits insuffisants pour effectuer cette opération</p>\n";
		require("../lib/footer.inc.php");
		die();
	}
...
Le dépot de fichiers de signature pour les différents utilisateurs et classes n'est pour le moment possible qu'en tant qu'administrateur dans Gestion des modules/Bulletins\" /></a></p>\n";
	...
	echo "<p align='center'><input type='submit' name='bouton_valide_select_eleves1' value='Valider' />\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
...
display_param_b_adr_pg();
	...
	echo "</form>\n";
        ...
        //Célestin 270516
        //AJOUT DE LA FONCTION DE RECOPIE
        echo "<form enctype='multipart/form-data' action='recopie.php/?' method='post' name='recopie' target='_blank'>"
        . "<input type='hidden' name='periode' value='$tab_periode_num[0]'/> "
        . "<input type='hidden' name='classe' value='$tab_id_classe[0]'/> "
        . "<input type='submit' name='recopie_note' value='Recopier' /></p>\n"
                . "</form>";
