...
if (($nb_test == 0) and ($id_classe != -1) and ($delai != 0)) {
    if ($delai == "") die("Erreur : Délai de visualisation du travail personnel non défini. Contactez l'administrateur de GEES de votre établissement.");
    $nb_dev = 0;
    for ($i = 0; $i <= $delai; $i++) {
    ...
    echo "<br /><br /><p>Ce cahier de textes est géré sous <a href='http://gepi.mutualibre.org/'>GEES</a>.\n<br />GEES est un outil de gestion, de suivi, et de visualisation graphique des résultats scolaires (écoles, collèges, lycées).\n<br />GEES est un logiciel libre et gratuit diffusé sous la licence GPL.</p><br />\n";
    echo "</center>";
	require("../lib/footer.inc.php");
    die();
}
...
if ($delai == "") die("Erreur : Délai de visualisation des devois non défini. Contactez l'administrateur de GEES de votre établissement.");
